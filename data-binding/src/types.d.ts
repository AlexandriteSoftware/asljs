export type PipeFn = (value: unknown, ...args: string[]) => unknown;
/**
...
export type BindingSpec = ValueBindingSpec | EventBindingSpec;
export type BindDataModelOptions = {
    pipes?: Record<string, PipeFn>;
};
export type DataModel = Record<string, unknown>;
export type DataModelWithOn = DataModel & {
    on: (event: string, listener: (...args: unknown[]) => void) => (() => boolean) | void;
};
export type DataModelWithWatch = DataModel & {
    watch: (property: string | readonly string[], callback: (...values: unknown[]) => void) => (() => boolean) | void;
};
