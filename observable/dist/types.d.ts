...
export type ObservableFn = {
    ...
    <T extends readonly any[]>(value: T, options?: ObservableOptions): T & Eventful<ObservableEventsArray<T>>;
    /** Object overload (includes 'define' events) */
    <T extends object>(value: T, options?: ObservableOptions): T & Eventful<ObservableEventsObject<T>>;
    /** Primitive overload (boxed as { value }) */
    <T>(value?: T, options?: ObservableOptions): {
        value: T;
