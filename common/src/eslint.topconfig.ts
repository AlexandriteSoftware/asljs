...
import jsImportStyleRule
  from './eslint-style-rules/js-style-rules/import.js';
import jsFunctionDeclarationStyleRule
  from './eslint-style-rules/js-style-rules/function-declaration.js';
import jsCallExpressionStyleRule
  from './eslint-style-rules/js-style-rules/call-expression.js';
import jsVariableDeclarationStyleRule
  from './eslint-style-rules/js-style-rules/variable-declaration.js';
import jsStatementSpacingStyleRule
  from './eslint-style-rules/js-style-rules/statement-spacing.js';
