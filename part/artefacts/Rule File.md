...
- The first comment in the rule file should have the exact text from
  the rule description in the definition file, for example,
...
- RL1 - the first multiline comment in the JS rule file should include the
  rule description exactly as it is in the definition file. See the example
  below.
