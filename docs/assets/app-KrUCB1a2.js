(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();class Nn extends Error{constructor(n,t,a,s,r){super(n),this.name="ListenerError",this.error=t,this.object=a,this.event=s,this.listener=r}}function $(e){if(typeof e!="string"&&typeof e!="symbol")throw new TypeError("Expect event to be a string or symbol.")}function oe(e){return typeof e=="function"}function Ce(e){if(oe(e))return e}function Ge(e){return typeof e=="object"&&e!==null}function de(e){if(!oe(e))throw new TypeError("Expect a function.")}const Pn=(e=Object.create(null),n={})=>{if(!Ge(e)&&!oe(e))throw new TypeError("Expect an object or a function.");for(const c of["on","once","off","emit","emitAsync","has"])if(c in e)throw new Error(`Method "${c}" already exists.`);const{strict:t=!1,trace:a=null,error:s=null}=n,r=Ce(a)??null,i=Ce(s)??null,u=e!==D,b=(c,p)=>{r==null||r(c,p),u&&D.emit(c,p)};b("new",{object:e});const E=new Set,g=new Map,h={enumerable:!1,configurable:!0,writable:!0};return Object.defineProperties(e,{on:Object.assign({value:j},h),once:Object.assign({value:S},h),off:Object.assign({value:y},h),emit:Object.assign({value:A},h),emitAsync:Object.assign({value:L},h),has:Object.assign({value:x},h)}),e;function l(c,p){let f=g.get(c);f||g.set(c,f=new Set),f.add(p)}function v(c,p){const f=g.get(c);if(!f)return!1;const w=f.delete(p);return f.size===0&&g.delete(c),w}function m(c,p,f){const w={error:f,object:e,event:c,listener:p};if(i==null||i(w),e===D&&c==="error")throw new Nn("Error in a global error listener.",f,e,c,p);D.emit("error",w)}function j(c,p){$(c),de(p),b("on",{object:e,event:c,listener:p}),l(c,p);let f=!0;return()=>f?(f=!1,v(c,p)):!1}function S(c,p){$(c),de(p);const f=j(c,(...w)=>{f(),p(...w)});return f}function y(c,p){return $(c),de(p),b("off",{object:e,event:c,listener:p}),v(c,p)}function x(c){var p;return $(c),(((p=g.get(c))==null?void 0:p.size)??0)>0}function A(c,...p){$(c);const f=g.get(c)||E;if(b("emit",{object:e,listeners:[...f],event:c,args:p}),f.size!==0)for(const w of f)try{w(...p)}catch(O){if(m(c,w,O),t)throw O}}async function L(c,...p){$(c);const f=g.get(c)||E;if(b("emitAsync",{object:e,listeners:[...f],event:c,args:p}),f.size===0)return;const w=[...f].map(async O=>{try{await O(...p)}catch(Pe){if(m(c,O,Pe),t)throw Pe}});await(t?Promise.all(w):Promise.allSettled(w))}},D=Pn;D(D);function Cn(e){return!Ge(e)&&!oe(e)?!1:typeof e.on=="function"}function qe(e){if(Cn(e))return e}function T(e){return typeof e=="function"}function Se(e){return typeof e=="object"&&e!==null}function We(e){if(!T(e))throw new TypeError("Expect a function.")}function fe(e){if(e.trim()==="")throw new TypeError("Expect watch path to be a non-empty string.");const n=e.split(".");for(const t of n)if(t.trim()==="")throw new TypeError("Expect watch path segments to be non-empty.");return e.split(".").map(t=>t.trim()).filter(t=>t!=="")}function Rn(e,n){const t=fe(n);if(t.length===0)return;let a=e;for(const s of t){if(!Se(a)||!(s in a))return;a=a[s]}return a}const Ke=(e,n,t)=>{if(Array.isArray(e))throw new TypeError("Watching arrays is not supported.");We(t);const a=typeof n=="string"?[n]:n;if(!Array.isArray(a))throw new TypeError("Expect properties to be a string or an array of strings.");for(const i of a){if(typeof i!="string")throw new TypeError("Expect properties to be a string or an array of strings.");fe(i)}const s=()=>a.map(i=>Rn(e,i)),r=[];for(const i of a){const u=fe(i);let b=null;const E=()=>{const g=[],h=(l,v)=>{if(!Se(l)||v>=u.length)return;const m=u[v],j=qe(l);if(j){const S=j.on(`set:${m}`,()=>{t(...s()),v<u.length-1&&b&&(b(),b=E())});g.push(S)}v<u.length-1&&h(l[m],v+1)};return h(e,0),()=>g.reduce((l,v)=>v()||l,!1)};b=E(),r.push(()=>b?b():!1)}return t(...s()),()=>r.reduce((i,u)=>u()||i,!1)};function Fn(e,n){"watch"in e||Object.defineProperty(e,"watch",{configurable:!0,writable:!0,enumerable:!1,value(t,a){return n(typeof t=="string"?this:this,t,a)}})}function Re(e,n){return Object.prototype.hasOwnProperty.call(e,n)}function pe(e){if(typeof e=="symbol")return!1;const n=typeof e=="number"?e:Number(e);return!Number.isInteger(n)||n<0||n>=4294967295?!1:typeof e=="number"||e===String(n)}function Mn(e){return qe(e)?T(e.emit):!1}const ze=(e,n={})=>{const{eventful:t=D,trace:a=null,shallow:s=!1}=n;We(t);const r=ie.options,i=new WeakMap,u=l=>{if(s||!Se(l)||Mn(l))return l;if(i.has(l))return i.get(l);const v=ze(l,{eventful:t,trace:a,shallow:s});return i.set(l,v),v},b=l=>{if(!s){if(Array.isArray(l)){for(let v=0;v<l.length;v++)l[v]=u(l[v]);return}for(const v of Reflect.ownKeys(l))Re(l,v)&&(l[v]=u(l[v]))}},E=l=>{const v=Array.isArray(l);b(l),Fn(l,Ke);let m;const j=new Proxy(l,{set(S,y,x,A){const L=v&&pe(y),c=Reflect.get(S,y,A),p=Reflect.set(S,y,u(x),A);if(m&&p){const f=Reflect.get(S,y,A);if(!Object.is(c,f)){const w=L?{index:Number(y),value:f,previous:c}:{property:y,value:f,previous:c},O=a||r.trace;m.emit(`set:${String(y)}`,w),T(O)&&O(m,"set",w),m.emit("set",w)}}return p},deleteProperty(S,y){const x=v&&pe(y),A=Re(S,y),L=A?S[y]:void 0,c=Reflect.deleteProperty(S,y);if(m&&c&&A){const p=x?{index:Number(y),previous:L}:{property:y,previous:L},f=a||r.trace;m.emit(`delete:${String(y)}`,p),T(f)&&f(m,"delete",p),m.emit("delete",p)}return c},defineProperty(S,y,x){const A=Object.getOwnPropertyDescriptor(S,y)??null,L=Object.prototype.hasOwnProperty.call(x,"value")?{...x,value:u(x.value)}:x,c=Reflect.defineProperty(S,y,L),p=v&&(y==="length"||pe(y));if(m&&!p&&c){const f={property:y,descriptor:L,previous:A},w=a||r.trace;m.emit(`define:${String(y)}`,f),T(w)&&w(m,"define",f),m.emit("define",f)}return c}});return m=T(l==null?void 0:l.emit)?j:t(j),m},g=a||r.trace;if(Array.isArray(e)){const l=E(e);return T(g)&&g(l,"new"),l}if(e!==null&&typeof e=="object"){const l=E(e);return T(g)&&g(l,"new",{object:l}),l}const h=t({get value(){return e},set value(l){if(Object.is(l,e))return;const v=e;e=l;const m={property:"value",value:e,previous:v};h.emit("set:value",m),T(g)&&g(h,"set",m),h.emit("set",m)}});return T(g)&&g(h,"new",{object:h}),h},ie=ze;ie.options={trace:null};ie.watch=Ke;const o=ie({apps:[],currentAppId:null,files:[],activeFileName:null,generating:!1,error:null});function F(e){return new Promise((n,t)=>{e.addEventListener("success",()=>{n(e.result)}),e.addEventListener("error",()=>{t(e.error??new Error("IndexedDB request failed"))})})}function Dn(e,n){return new Promise((t,a)=>{const s=indexedDB.open(e,n.length);s.addEventListener("upgradeneeded",r=>{const i=n.slice(r.oldVersion-1,r.newVersion??n.length-1);for(const u of i)u(s.result)}),s.addEventListener("success",()=>{t(s.result)}),s.addEventListener("blocked",()=>{a(new Error("Database opening is blocked"))}),s.addEventListener("error",()=>{a(s.error??new Error("Failed to open database"))})})}const _n="asljs-app-builder";let Z=null;async function J(){return Z!==null||(Z=await Dn(_n,[e=>{e.createObjectStore("apps",{keyPath:"id"}),e.createObjectStore("files",{keyPath:"id"}).createIndex("byAppId","appId",{unique:!1})}])),Z}async function Bn(){const n=(await J()).transaction("apps","readonly");return F(n.objectStore("apps").getAll())}async function H(e){const t=(await J()).transaction("apps","readwrite");await F(t.objectStore("apps").put(e))}async function $n(e){const t=(await J()).transaction("files","readonly");return F(t.objectStore("files").index("byAppId").getAll(e))}async function me(e){const t=(await J()).transaction("files","readwrite");await F(t.objectStore("files").put(e))}async function Un(e){const t=(await J()).transaction("files","readwrite");await F(t.objectStore("files").delete(e))}async function Jn(e,n){const s=(await J()).transaction("files","readwrite").objectStore("files"),r=await F(s.index("byAppId").getAllKeys(e));for(const i of r)await F(s.delete(i));for(const i of n)await F(s.put(i))}const Vn=`# observable
...
`,at=[{type:"function",name:"listFileset",description:"List all file paths in the virtual filesystem.",parameters:{type:"object",properties:{},required:[],additionalProperties:!1},strict:!0},{type:"function",name:"readFile",description:"Read the full text content of a file.",parameters:{type:"object",properties:{path:{type:"string"}},required:["path"],additionalProperties:!1},strict:!0},{type:"function",name:"setFileContent",description:"Create or fully replace file content.",parameters:{type:"object",properties:{path:{type:"string"},content:{type:"string"}},required:["path","content"],additionalProperties:!1},strict:!0},{type:"function",name:"replaceFilePart",description:"Replace part of a file by exact search string.",parameters:{type:"object",properties:{path:{type:"string"},search:{type:"string"},replacement:{type:"string"},replaceAll:{type:"boolean"}},required:["path","search","replacement","replaceAll"],additionalProperties:!1},strict:!0},{type:"function",name:"deleteFile",description:"Delete a file from the virtual filesystem.",parameters:{type:"object",properties:{path:{type:"string"}},required:["path"],additionalProperties:!1},strict:!0},{type:"function",name:"evalInApp",description:"Evaluate JavaScript in the running app document context.",parameters:{type:"object",properties:{code:{type:"string"}},required:["code"],additionalProperties:!1},strict:!0},{type:"function",name:"getAppDiagnostics",description:"Get current runtime logs and errors from the running app.",parameters:{type:"object",properties:{},required:[],additionalProperties:!1},strict:!0},{type:"function",name:"runAppAndCollectDiagnostics",description:"Run the app and collect runtime logs and errors after startup.",parameters:{type:"object",properties:{},required:[],additionalProperties:!1},strict:!0}],rt="https://api.openai.com/v1/responses",ot=Y(Zn,"asljs-observable"),it=Y(et,"asljs-eventful"),lt=Y(nt,"asljs-data-binding"),ct=Y(tt,"asljs-components"),dt=Y(st,"asljs-dali"),He=gt(),pt="gpt-5.3-codex",q=20;function ut(){return He}const ft=12;async function mt(e,n,t,a,s){var E;let r,i=e,u=vt(s==null?void 0:s.initialToolStepLimit),b=0;for(;;){if(await V(s,`Step ${b+1}: requesting assistant response...`),b>=u){if(!(await((E=s==null?void 0:s.onToolStepLimit)==null?void 0:E.call(s,{stepsCompleted:b,stepLimit:u}))??!1))throw new Error("AI exceeded maximum tool steps without completing.");u+=ft,await V(s,`Extended step limit to ${u}. Continuing...`)}const g=await fetch(rt,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${n}`},body:JSON.stringify({model:t,instructions:He,temperature:.1,previous_response_id:r,input:i,tools:at})});if(!g.ok){const m=await g.json().catch(()=>({})),j=bt(m)??`OpenAI API error: ${g.status}`;throw new Error(j)}const h=await g.json();if(!Array.isArray(h.output))throw new Error("AI returned an unexpected response format.");const l=h.output.filter(wt);if(l.length===0){await V(s,`Completed in ${b+1} step(s). Finalizing summary...`);const m=St(h);return{summary:m===""?"Completed tool-based update.":m}}const v=[];for(const m of l){await V(s,`Step ${b+1}: running ${Ye(m)}...`);const j=await ht(m,a);v.push({type:"function_call_output",call_id:Et(m),output:j})}await V(s,`Step ${b+1}: submitted ${v.length} tool result(s).`),r=typeof h.id=="string"?h.id:r,i=v,b+=1}}function vt(e){if(!Number.isFinite(e))return q;const n=Math.floor(e);return n>=1?n:q}async function V(e,n){(e==null?void 0:e.onProgress)!==void 0&&await Promise.resolve(e.onProgress(n))}function gt(){const e=`
      Latest ASLJS package versions to use:
      - asljs-eventful@${it}
      - asljs-observable@${ot}
      - asljs-data-binding@${lt}
      - asljs-components@${ct}
      - asljs-dali@${dt}
    `,n=[G("eventful",Gn,Hn),G("observable",Vn,zn),G("data-binding",qn,Yn),G("components",Wn,Qn),G("dali",Kn,Xn)].join(`
...
... [truncated]`}function Y(e,n){try{return JSON.parse(e).version??"latest"}catch{return console.warn(`Failed to parse package metadata for ${n}.`),"latest"}}function bt(e){const n=e.error;return typeof(n==null?void 0:n.message)=="string"?n.message:null}async function ht(e,n){const t=Ye(e),a=yt(e.arguments);try{switch(t){case"listFileset":{const s=await n.listFileset();return P(s)}case"readFile":{const s=await n.readFile(N(a,"path"));return P(s)}case"setFileContent":return await n.setFileContent(N(a,"path"),N(a,"content")),P("ok");case"replaceFilePart":return await n.replaceFilePart(N(a,"path"),N(a,"search"),N(a,"replacement"),jt(a,"replaceAll",!1)),P("ok");case"deleteFile":return await n.deleteFile(N(a,"path")),P("ok");case"evalInApp":{const s=await n.evalInApp(N(a,"code"));return P(s)}case"getAppDiagnostics":{const s=await n.getAppDiagnostics();return P(s)}case"runAppAndCollectDiagnostics":{const s=await n.runAppAndCollectDiagnostics();return P(s)}default:return Me(`Unknown tool: ${t}`)}}catch(s){return Me(s instanceof Error?s.message:String(s))}}function yt(e){if(e===void 0)return{};if(typeof e=="object"&&e!==null)return e;if(typeof e!="string")throw new Error("Invalid tool arguments value.");try{const n=JSON.parse(e);if(typeof n!="object"||n===null)throw new Error("Tool arguments must be a JSON object.");return n}catch{throw new Error("Invalid tool arguments JSON.")}}function wt(e){return e.type==="function_call"}function Ye(e){if(typeof e.name!="string"||e.name.trim()==="")throw new Error("Tool call missing function name.");return e.name}function Et(e){if(typeof e.call_id!="string"||e.call_id.trim()==="")throw new Error("Tool call missing call_id.");return e.call_id}function St(e){return typeof e.output_text=="string"&&e.output_text.trim()!==""?e.output_text.trim():Array.isArray(e.output)?e.output.filter(t=>t.type==="message").flatMap(t=>t.content??[]).map(t=>t.text??"").map(t=>t.trim()).filter(t=>t!=="").join(`
`):""}function N(e,n){const t=e[n];if(typeof t!="string")throw new Error(`Tool argument "${n}" must be a string.`);return t}function jt(e,n,t){const a=e[n];if(a===void 0)return t;if(typeof a!="boolean")throw new Error(`Tool argument "${n}" must be a boolean.`);return a}function P(e){return Qe({ok:!0,value:e})}function Me(e){return Qe({ok:!1,error:e})}function Qe(e){try{return JSON.stringify(e)}catch{return'{"ok":false,"error":"Failed to serialize tool result."}'}}const je="asljs-app-builder:eval-request",Xe="asljs-app-builder:eval-response",Ze="asljs-app-builder:diagnostics-request",en="asljs-app-builder:diagnostics-response",De=`<script>
(() => {
  const REQUEST = '${je}';
  const RESPONSE = '${Xe}';
  const DIAG_REQUEST = '${Ze}';
  const DIAG_RESPONSE = '${en}';
...
<\/script>`;function xt(e,n){if(n.length===0){e.removeAttribute("srcdoc"),e.src="about:blank";return}const t=n.find(r=>r.name==="index.html")??n.find(r=>r.name.endsWith(".html"))??null;if(t===null){e.removeAttribute("srcdoc"),e.src="about:blank";return}let a=t.content;const s=n.find(r=>r.name==="style.css")??n.find(r=>r.name.endsWith(".css"))??null;s!==null&&(a=a.replace(/<link[^>]+href=["']style\.css["'][^>]*>/gi,`<style>${s.content}</style>`),a=a.replace(/<link[^>]+href=["']([^"']+\.css)["'][^>]*>/gi,`<style>${s.content}</style>`));for(const r of n){if(!r.name.endsWith(".js"))continue;const i=r.name.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");a=a.replace(new RegExp(`(<script[^>]*?)\\s+src=["']${i}["']([^>]*)><\\/script>`,"gi"),(u,b,E)=>{const g=`${String(b)} ${String(E)}`;return/type=["']module["']/i.test(g)?`<script type="module">${r.content}<\/script>`:`<script>${r.content}<\/script>`})}a=Tt(a,n),a=At(a),e.srcdoc=a}async function _e(e,n){const t=await tn(e,je,{code:n},Xe);if(t.ok===!0)return t.value;throw new Error(typeof t.error=="string"?t.error:"Unknown preview evaluation error.")}async function nn(e){const n=await tn(e,Ze,{},en);if(n.ok!==!0)throw new Error(typeof n.error=="string"?n.error:"Failed to read preview diagnostics.");return n.diagnostics??{logs:[],errors:[]}}async function tn(e,n,t,a){const s=e.contentWindow;if(s===null)throw new Error("Preview frame is not available.");const r=crypto.randomUUID();return new Promise((i,u)=>{const b=window.setTimeout(()=>{g(),u(new Error("Timed out waiting for app evaluation result."))},5e3),E=h=>{if(h.source!==s)return;const l=h.data;l.type!==a||l.id!==r||(g(),i(l))};function g(){window.clearTimeout(b),window.removeEventListener("message",E)}window.addEventListener("message",E),s.postMessage({type:n,id:r,...t},"*")})}function At(e){return e.includes(je)?e:e.includes("</body>")?e.replace("</body>",`${De}</body>`):`${e}
${De}`}function Tt(e,n){if(/type=["']importmap["']/i.test(e))return e;const t=n.find(i=>i.name==="package.json")??null,a=Lt(t==null?void 0:t.content),s=Object.fromEntries(a.map(([i,u])=>[i,`https://esm.sh/${i}@${u}?bundle`]));if(Object.keys(s).length===0)return e;const r=`<script type="importmap">${JSON.stringify({imports:s})}<\/script>`;return/<head[^>]*>/i.test(e)?e.replace(/<head[^>]*>/i,i=>`${i}
${r}`):`${r}
${e}`}function Lt(e){if(e===void 0)return Be();try{const n=JSON.parse(e),t={...n.dependencies??{},...n.devDependencies??{}};return["asljs-eventful","asljs-observable","asljs-data-binding","asljs-components","asljs-dali"].map(r=>[r,kt(t[r])])}catch{return Be()}}function kt(e){if(typeof e!="string"||e.trim()==="")return"latest";const n=e.trim().replace(/^[~^<>=\s]+/,"");return n===""?"latest":n}function Be(){return[["asljs-eventful","latest"],["asljs-observable","latest"],["asljs-data-binding","latest"],["asljs-components","latest"],["asljs-dali","latest"]]}function W(){return crypto.randomUUID()}function I(){return new Date().toISOString()}function d(e){const n=document.getElementById(e);if(n===null)throw new Error(`Missing element #${e}`);return n}const It=d("app-workspace"),Ot=d("first-app-setup"),sn=d("first-api-key-input"),K=d("first-app-name-input"),Nt=d("btn-create-first-app"),xe=d("panels"),$e=d("panel-chat"),Ue=d("panel-editor"),C=d("app-select"),k=d("file-select"),ne=d("file-content"),ee=d("chat-messages"),Je=d("chat-progress"),ve=d("chat-input"),ge=d("btn-generate"),Pt=d("btn-run"),Ct=d("btn-refresh-preview"),z=d("preview-frame"),Rt=d("btn-new-app"),Ft=d("btn-import"),Mt=d("btn-rename"),Dt=d("btn-export"),_t=d("btn-settings"),Bt=d("btn-agent-instructions"),be=d("btn-toggle-chat"),he=d("btn-toggle-files"),te=d("settings-modal"),$t=d("btn-close-settings"),Ut=d("btn-save-settings"),Jt=d("btn-cancel-settings"),ye=d("api-key-input"),an=d("model-select"),rn=d("theme-select"),on=d("font-size-input"),ln=d("max-tool-steps-input"),_=d("name-modal"),cn=d("name-modal-title"),R=d("app-name-input"),Q=d("btn-confirm-name"),Vt=d("btn-cancel-name"),Gt=d("btn-close-name-modal"),se=d("import-file"),ae=d("agent-instructions-modal"),we=d("agent-instructions-text"),qt=d("btn-close-agent-instructions"),Wt=d("btn-close-agent-instructions-2"),Kt=d("btn-copy-agent-instructions"),dn="asljs-app-builder-settings",pn="light",Ee=14,un="__new__",fn="__import__";function B(){try{const e=localStorage.getItem(dn)??"{}";return JSON.parse(e)}catch{return{}}}function mn(e){localStorage.setItem(dn,JSON.stringify(e))}function Ae(){return B().apiKey??""}function vn(){const e=B().model;return e==="gpt-5.3-codex"||e==="gpt-5.4"?e:pt}function gn(){const e=B().maxToolSteps;if(!Number.isFinite(e))return q;const n=Math.floor(e);return n<1?q:n}function bn(){return B().theme==="light"?"light":pn}function hn(){const e=B().fontSize;if(!Number.isFinite(e))return Ee;const n=Math.floor(e);return n<12||n>20?Ee:n}function yn(){document.body.dataset.theme=bn(),document.documentElement.style.fontSize=`${hn()}px`}function zt(){if(o.currentAppId===null)throw new Error("No active app. Create or open an app first.");return o.currentAppId}async function wn(){return[...o.files].map(e=>e.name).sort((e,n)=>e.localeCompare(n))}async function Te(e){const n=o.files.find(t=>t.name===e);if(n===void 0)throw new Error(`File not found: ${e}`);return n.content}async function Le(e,n){const t=zt(),a=o.files.find(r=>r.name===e);if(a!==void 0){const r={...a,content:n};await me(r),o.files=o.files.map(i=>i.id===r.id?r:i),o.activeFileName=r.name;return}const s={id:W(),appId:t,name:e,content:n};await me(s),o.files=[...o.files,s],o.activeFileName=s.name}async function En(e){var a;const n=o.files.find(s=>s.name===e);if(n===void 0)return;await Un(n.id);const t=o.files.filter(s=>s.id!==n.id);o.files=t,o.activeFileName===e&&(o.activeFileName=((a=t[0])==null?void 0:a.name)??null)}async function Sn(e,n,t,a=!1){if(n==="")throw new Error("Search text cannot be empty.");const s=await Te(e);if(!s.includes(n))throw new Error(`Search text not found in ${e}.`);let r=s;if(a)r=s.split(n).join(t);else{const i=s.indexOf(n);if(s.indexOf(n,i+n.length)!==-1)throw new Error("Search text is ambiguous. Use replaceAll=true or provide a more specific search block.");r=s.slice(0,i)+t+s.slice(i+n.length)}await Le(e,r)}async function jn(e){if(o.files.length===0)throw new Error("No files available to run.");U();try{return await _e(z,e)}catch{return U(),_e(z,e)}}async function xn(){return nn(z)}async function An(){return U(),await Ht(350),nn(z)}function Ht(e){return new Promise(n=>{window.setTimeout(n,e)})}function re(){C.replaceChildren();const e=[...o.apps].sort((a,s)=>s.updatedAt.localeCompare(a.updatedAt));for(const a of e){const s=document.createElement("option");s.value=a.id,s.textContent=a.name,C.appendChild(s)}if(e.length>0){const a=document.createElement("option");a.value="__separator__",a.textContent="────────",a.disabled=!0,C.appendChild(a)}const n=document.createElement("option");n.value=un,n.textContent="New...",C.appendChild(n);const t=document.createElement("option");t.value=fn,t.textContent="Import...",C.appendChild(t),o.currentAppId!==null&&(C.value=o.currentAppId)}function Tn(){It.classList.remove("hidden");const e=o.currentAppId!==null&&o.apps.some(n=>n.id===o.currentAppId);if(Ot.classList.toggle("hidden",e),xe.classList.toggle("hidden",!e),!e){sn.value=Ae(),K.value="";return}ke(),Ie()}async function Ln(){const e=K.value.trim();if(e===""){K.focus();return}const n=sn.value.trim();if(n!==""){const a=B();a.apiKey=n,mn(a)}const t={id:W(),name:e,createdAt:I(),updatedAt:I()};await H(t),o.apps=[...o.apps,t],await X(t.id)}function ke(){if(k.replaceChildren(),o.files.length===0){const n=document.createElement("option");n.value="",n.textContent="No files",k.appendChild(n),k.value="",k.disabled=!0;return}for(const n of o.files){const t=document.createElement("option");t.value=n.name,t.textContent=n.name,k.appendChild(t)}const e=o.activeFileName??o.files[0].name;k.value=e,k.disabled=!1}function Ie(){const e=o.files.find(n=>n.name===o.activeFileName);ne.value=(e==null?void 0:e.content)??"",ne.disabled=e===void 0}function Ve(e){o.generating=e,ge.disabled=e,ge.innerHTML=e?'<span class="spinner"></span> Sending…':"Send"}function ue(e,n){Je.textContent=e,Je.classList.toggle("hidden",!n)}function M(e,n){const t=document.createElement("div");t.className=`chat-msg ${e}`;const a=document.createElement("div");a.className="chat-msg-role",a.textContent=e==="user"?"You":"Assistant";const s=document.createElement("div");s.className="chat-bubble",s.textContent=n,t.appendChild(a),t.appendChild(s),ee.appendChild(t),ee.scrollTop=ee.scrollHeight}async function le(){if(o.activeFileName===null||o.currentAppId===null)return;const e=o.files.find(t=>t.name===o.activeFileName);if(e===void 0)return;const n=ne.value;e.content!==n&&(e.content=n,await me(e))}async function X(e){var t;o.currentAppId=e;const n=await $n(e);o.files=n,o.activeFileName=((t=n[0])==null?void 0:t.name)??null,ee.replaceChildren()}function kn(){cn.textContent="New App",R.value="",_.classList.remove("hidden"),R.focus(),Q.onclick=async()=>{const e=R.value.trim();if(e==="")return;_.classList.add("hidden");const n={id:W(),name:e,createdAt:I(),updatedAt:I()};await H(n),o.apps=[...o.apps,n],await X(n.id)}}function Oe(){_.classList.add("hidden"),Q.onclick=null}function Yt(){const e=o.apps.find(n=>n.id===o.currentAppId);e!==void 0&&(cn.textContent="Rename App",R.value=e.name,_.classList.remove("hidden"),R.focus(),R.select(),Q.onclick=async()=>{const n=R.value.trim();if(n==="")return;_.classList.add("hidden");const t={...e,name:n,updatedAt:I()};await H(t),o.apps=o.apps.map(a=>a.id===e.id?t:a)})}async function In(){const e=ve.value.trim();if(e==="")return;const n=Ae();if(n===""){M("assistant","No OpenAI API key set. Open Settings (⚙) to add your key. Generation is optional — you can also create files manually.");return}if(o.currentAppId===null){M("assistant","Please create or open an app first.");return}ve.value="",M("user",e),Ve(!0),ue("Starting generation...",!0);try{const t=vn(),a=gn(),s=await mt(e,n,t,{listFileset:wn,readFile:Te,setFileContent:Le,replaceFilePart:Sn,deleteFile:En,evalInApp:jn,getAppDiagnostics:xn,runAppAndCollectDiagnostics:An},{initialToolStepLimit:a,onToolStepLimit:async({stepsCompleted:i})=>confirm(`AI reached ${i} tool steps without finishing. Continue for 12 more steps?`),onProgress:i=>{ue(i,!0)}}),r=o.apps.find(i=>i.id===o.currentAppId);if(r!==void 0){const i={...r,updatedAt:I()};await H(i),o.apps=o.apps.map(u=>u.id===r.id?i:u)}M("assistant",s.summary),U()}catch(t){const a=t instanceof Error?t.message:String(t);M("assistant",`Error: ${a}`)}finally{ue("",!1),Ve(!1)}}function U(){le().then(()=>{xt(z,o.files)})}async function Qt(){const e=o.apps.find(r=>r.id===o.currentAppId);if(e===void 0)return;await le();const n={app:e,files:o.files,exportedAt:I()},t=new Blob([JSON.stringify(n,null,2)],{type:"application/json"}),a=URL.createObjectURL(t),s=document.createElement("a");s.href=a,s.download=`${e.name.replace(/\s+/g,"-")}.json`,s.click(),URL.revokeObjectURL(a)}function On(){se.value="",se.click()}async function Xt(){var n;const e=(n=se.files)==null?void 0:n[0];if(e!==void 0)try{const t=await e.text(),a=JSON.parse(t);if(a.app===void 0||typeof a.app.name!="string"||!Array.isArray(a.files))throw new Error("Invalid app JSON format.");const s=W(),r={id:s,name:`${a.app.name} (imported)`,createdAt:a.app.createdAt??I(),updatedAt:I()},i=a.files.filter(u=>typeof u.name=="string"&&typeof u.content=="string").map(u=>({id:W(),appId:s,name:u.name,content:u.content}));await H(r),await Jn(s,i),o.apps=[...o.apps,r],await X(s)}catch(t){const a=t instanceof Error?t.message:String(t);alert(`Import failed: ${a}`)}}function Zt(){ye.value=Ae(),an.value=vn(),rn.value=bn(),on.value=String(hn()),ln.value=String(gn()),te.classList.remove("hidden"),ye.focus()}function ce(){te.classList.add("hidden")}function es(){const e=B();e.apiKey=ye.value.trim(),e.model=an.value==="gpt-5.4"?"gpt-5.4":"gpt-5.3-codex",e.theme=rn.value==="light"?"light":pn;const n=Number.parseInt(on.value,10);e.fontSize=Number.isFinite(n)&&n>=12&&n<=20?n:Ee;const t=Number.parseInt(ln.value,10);e.maxToolSteps=Number.isFinite(t)&&t>=1?t:q,mn(e),yn(),ce()}function ns(){we.value=ut(),ae.classList.remove("hidden"),we.scrollTop=0}function Ne(){ae.classList.add("hidden")}function ts(){const e=!$e.classList.contains("collapsed");be.textContent=e?"Chat ▸":"Chat ▾",be.setAttribute("aria-expanded",e?"false":"true"),$e.classList.toggle("collapsed",e),xe.classList.toggle("chat-collapsed",e)}function ss(){const e=!Ue.classList.contains("collapsed");he.textContent=e?"Files ▸":"Files ▾",he.setAttribute("aria-expanded",e?"false":"true"),Ue.classList.toggle("collapsed",e),xe.classList.toggle("files-collapsed",e)}async function as(){const e=we.value;try{await navigator.clipboard.writeText(e),M("assistant","Agent instructions copied to clipboard.")}catch{M("assistant","Could not copy to clipboard automatically. You can still select and copy from the instructions modal.")}}o.on("set:apps",()=>re());o.on("set:currentAppId",()=>{re(),Tn()});o.on("set:files",()=>{ke(),Ie()});o.on("set:activeFileName",()=>{ke(),Ie()});Rt.addEventListener("click",kn);Ft.addEventListener("click",On);Mt.addEventListener("click",Yt);Dt.addEventListener("click",()=>{Qt()});ge.addEventListener("click",()=>{In()});Pt.addEventListener("click",U);Ct.addEventListener("click",U);_t.addEventListener("click",Zt);Bt.addEventListener("click",ns);be.addEventListener("click",ts);he.addEventListener("click",ss);$t.addEventListener("click",ce);Ut.addEventListener("click",es);Jt.addEventListener("click",ce);te.addEventListener("click",e=>{e.target===te&&ce()});qt.addEventListener("click",Ne);Wt.addEventListener("click",Ne);Kt.addEventListener("click",()=>{as()});ae.addEventListener("click",e=>{e.target===ae&&Ne()});Q.addEventListener("click",()=>{});Vt.addEventListener("click",Oe);Gt.addEventListener("click",Oe);_.addEventListener("click",e=>{e.target===_&&Oe()});R.addEventListener("keydown",e=>{e.key==="Enter"&&Q.click()});Nt.addEventListener("click",()=>{Ln()});K.addEventListener("keydown",e=>{e.key==="Enter"&&(e.preventDefault(),Ln())});ve.addEventListener("keydown",e=>{e.key==="Enter"&&!e.shiftKey&&(e.preventDefault(),In())});C.addEventListener("change",()=>{const e=C.value;if(e===un){kn(),re();return}if(e===fn){On(),re();return}e!==""&&e!==o.currentAppId&&X(e)});k.addEventListener("change",()=>{const e=k.value;e===""||e===o.activeFileName||(le(),o.activeFileName=e)});ne.addEventListener("blur",()=>{le()});se.addEventListener("change",()=>{Xt()});window.listFileset=wn;window.readFile=Te;window.setFileContent=Le;window.replaceFilePart=Sn;window.deleteFile=En;window.evalInApp=jn;window.getAppDiagnostics=xn;window.runAppAndCollectDiagnostics=An;async function rs(){yn();const e=await Bn();if(o.apps=e,e.length>0){const n=[...e].sort((t,a)=>a.updatedAt.localeCompare(t.updatedAt));await X(n[0].id)}else o.currentAppId=null,o.files=[],o.activeFileName=null,Tn(),K.focus()}rs().catch(e=>{console.error("App Builder init failed:",e)});
