(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function t(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(s){if(s.ep)return;s.ep=!0;const o=t(s);fetch(s.href,o)}})();class Fn extends Error{constructor(n,t,a,s,o){super(n),this.name="ListenerError",this.error=t,this.object=a,this.event=s,this.listener=o}}function $(e){if(typeof e!="string"&&typeof e!="symbol")throw new TypeError("Expect event to be a string or symbol.")}function le(e){return typeof e=="function"}function $e(e){if(le(e))return e}function Qe(e){return typeof e=="object"&&e!==null}function ge(e){if(!le(e))throw new TypeError("Expect a function.")}const _n=(e=Object.create(null),n={})=>{if(!Qe(e)&&!le(e))throw new TypeError("Expect an object or a function.");for(const d of["on","once","off","emit","emitAsync","has"])if(d in e)throw new Error(`Method "${d}" already exists.`);const{strict:t=!1,trace:a=null,error:s=null}=n,o=$e(a)??null,i=$e(s)??null,p=e!==_,v=(d,u)=>{o==null||o(d,u),p&&_.emit(d,u)};v("new",{object:e});const E=new Set,b=new Map,h={enumerable:!1,configurable:!0,writable:!0};return Object.defineProperties(e,{on:Object.assign({value:j},h),once:Object.assign({value:S},h),off:Object.assign({value:y},h),emit:Object.assign({value:L},h),emitAsync:Object.assign({value:O},h),has:Object.assign({value:k},h)}),e;function c(d,u){let m=b.get(d);m||b.set(d,m=new Set),m.add(u)}function g(d,u){const m=b.get(d);if(!m)return!1;const w=m.delete(u);return m.size===0&&b.delete(d),w}function f(d,u,m){const w={error:m,object:e,event:d,listener:u};if(i==null||i(w),e===_&&d==="error")throw new Fn("Error in a global error listener.",m,e,d,u);_.emit("error",w)}function j(d,u){$(d),ge(u),v("on",{object:e,event:d,listener:u}),c(d,u);let m=!0;return()=>m?(m=!1,g(d,u)):!1}function S(d,u){$(d),ge(u);const m=j(d,(...w)=>{m(),u(...w)});return m}function y(d,u){return $(d),ge(u),v("off",{object:e,event:d,listener:u}),g(d,u)}function k(d){var u;return $(d),(((u=b.get(d))==null?void 0:u.size)??0)>0}function L(d,...u){$(d);const m=b.get(d)||E;if(v("emit",{object:e,listeners:[...m],event:d,args:u}),m.size!==0)for(const w of m)try{w(...u)}catch(N){if(f(d,w,N),t)throw N}}async function O(d,...u){$(d);const m=b.get(d)||E;if(v("emitAsync",{object:e,listeners:[...m],event:d,args:u}),m.size===0)return;const w=[...m].map(async N=>{try{await N(...u)}catch(Be){if(f(d,N,Be),t)throw Be}});await(t?Promise.all(w):Promise.allSettled(w))}},_=_n;_(_);function Bn(e){return!Qe(e)&&!le(e)?!1:typeof e.on=="function"}function Xe(e){if(Bn(e))return e}function I(e){return typeof e=="function"}function Le(e){return typeof e=="object"&&e!==null}function Ze(e){if(!I(e))throw new TypeError("Expect a function.")}function he(e){if(e.trim()==="")throw new TypeError("Expect watch path to be a non-empty string.");const n=e.split(".");for(const t of n)if(t.trim()==="")throw new TypeError("Expect watch path segments to be non-empty.");return e.split(".").map(t=>t.trim()).filter(t=>t!=="")}function $n(e,n){const t=he(n);if(t.length===0)return;let a=e;for(const s of t){if(!Le(a)||!(s in a))return;a=a[s]}return a}const en=(e,n,t)=>{if(Array.isArray(e))throw new TypeError("Watching arrays is not supported.");Ze(t);const a=typeof n=="string"?[n]:n;if(!Array.isArray(a))throw new TypeError("Expect properties to be a string or an array of strings.");for(const i of a){if(typeof i!="string")throw new TypeError("Expect properties to be a string or an array of strings.");he(i)}const s=()=>a.map(i=>$n(e,i)),o=[];for(const i of a){const p=he(i);let v=null;const E=()=>{const b=[],h=(c,g)=>{if(!Le(c)||g>=p.length)return;const f=p[g],j=Xe(c);if(j){const S=j.on(`set:${f}`,()=>{t(...s()),g<p.length-1&&v&&(v(),v=E())});b.push(S)}g<p.length-1&&h(c[f],g+1)};return h(e,0),()=>b.reduce((c,g)=>g()||c,!1)};v=E(),o.push(()=>v?v():!1)}return t(...s()),()=>o.reduce((i,p)=>p()||i,!1)};function Un(e,n){"watch"in e||Object.defineProperty(e,"watch",{configurable:!0,writable:!0,enumerable:!1,value(t,a){return n(typeof t=="string"?this:this,t,a)}})}function Ue(e,n){return Object.prototype.hasOwnProperty.call(e,n)}function ve(e){if(typeof e=="symbol")return!1;const n=typeof e=="number"?e:Number(e);return!Number.isInteger(n)||n<0||n>=4294967295?!1:typeof e=="number"||e===String(n)}function Jn(e){return Xe(e)?I(e.emit):!1}const nn=(e,n={})=>{const{eventful:t=_,trace:a=null,shallow:s=!1}=n;Ze(t);const o=ce.options,i=new WeakMap,p=c=>{if(s||!Le(c)||Jn(c))return c;if(i.has(c))return i.get(c);const g=nn(c,{eventful:t,trace:a,shallow:s});return i.set(c,g),g},v=c=>{if(!s){if(Array.isArray(c)){for(let g=0;g<c.length;g++)c[g]=p(c[g]);return}for(const g of Reflect.ownKeys(c))Ue(c,g)&&(c[g]=p(c[g]))}},E=c=>{const g=Array.isArray(c);v(c),Un(c,en);let f;const j=new Proxy(c,{set(S,y,k,L){const O=g&&ve(y),d=Reflect.get(S,y,L),u=Reflect.set(S,y,p(k),L);if(f&&u){const m=Reflect.get(S,y,L);if(!Object.is(d,m)){const w=O?{index:Number(y),value:m,previous:d}:{property:y,value:m,previous:d},N=a||o.trace;f.emit(`set:${String(y)}`,w),I(N)&&N(f,"set",w),f.emit("set",w)}}return u},deleteProperty(S,y){const k=g&&ve(y),L=Ue(S,y),O=L?S[y]:void 0,d=Reflect.deleteProperty(S,y);if(f&&d&&L){const u=k?{index:Number(y),previous:O}:{property:y,previous:O},m=a||o.trace;f.emit(`delete:${String(y)}`,u),I(m)&&m(f,"delete",u),f.emit("delete",u)}return d},defineProperty(S,y,k){const L=Object.getOwnPropertyDescriptor(S,y)??null,O=Object.prototype.hasOwnProperty.call(k,"value")?{...k,value:p(k.value)}:k,d=Reflect.defineProperty(S,y,O),u=g&&(y==="length"||ve(y));if(f&&!u&&d){const m={property:y,descriptor:O,previous:L},w=a||o.trace;f.emit(`define:${String(y)}`,m),I(w)&&w(f,"define",m),f.emit("define",m)}return d}});return f=I(c==null?void 0:c.emit)?j:t(j),f},b=a||o.trace;if(Array.isArray(e)){const c=E(e);return I(b)&&b(c,"new"),c}if(e!==null&&typeof e=="object"){const c=E(e);return I(b)&&b(c,"new",{object:c}),c}const h=t({get value(){return e},set value(c){if(Object.is(c,e))return;const g=e;e=c;const f={property:"value",value:e,previous:g};h.emit("set:value",f),I(b)&&b(h,"set",f),h.emit("set",f)}});return I(b)&&b(h,"new",{object:h}),h},ce=nn;ce.options={trace:null};ce.watch=en;const r=ce({apps:[],currentAppId:null,files:[],activeFileName:null,generating:!1,error:null});function A(e){return new Promise((n,t)=>{e.addEventListener("success",()=>{n(e.result)}),e.addEventListener("error",()=>{t(e.error??new Error("IndexedDB request failed"))})})}function Vn(e,n){return new Promise((t,a)=>{const s=indexedDB.open(e,n.length);s.addEventListener("upgradeneeded",o=>{const i=n.slice(o.oldVersion-1,o.newVersion??n.length-1);for(const p of i)p(s.result)}),s.addEventListener("success",()=>{t(s.result)}),s.addEventListener("blocked",()=>{a(new Error("Database opening is blocked"))}),s.addEventListener("error",()=>{a(s.error??new Error("Failed to open database"))})})}const qn="asljs-app-builder";let ee=null;async function B(){return ee!==null||(ee=await Vn(qn,[e=>{e.createObjectStore("apps",{keyPath:"id"}),e.createObjectStore("files",{keyPath:"id"}).createIndex("byAppId","appId",{unique:!1})}])),ee}async function Gn(){const n=(await B()).transaction("apps","readonly");return A(n.objectStore("apps").getAll())}async function G(e){const t=(await B()).transaction("apps","readwrite");await A(t.objectStore("apps").put(e))}async function Wn(e){const t=(await B()).transaction(["apps","files"],"readwrite");await A(t.objectStore("apps").delete(e));const a=t.objectStore("files"),s=await A(a.index("byAppId").getAllKeys(e));for(const o of s)await A(a.delete(o))}async function Kn(e){const t=(await B()).transaction("files","readonly");return A(t.objectStore("files").index("byAppId").getAll(e))}async function ye(e){const t=(await B()).transaction("files","readwrite");await A(t.objectStore("files").put(e))}async function Hn(e){const t=(await B()).transaction("files","readwrite");await A(t.objectStore("files").delete(e))}async function tn(e,n){const s=(await B()).transaction("files","readwrite").objectStore("files"),o=await A(s.index("byAppId").getAllKeys(e));for(const i of o)await A(s.delete(i));for(const i of n)await A(s.put(i))}const zn=`# observable
...
... [truncated]`}function X(e,n){try{return JSON.parse(e).version??"latest"}catch{return console.warn(`Failed to parse package metadata for ${n}.`),"latest"}}function jt(e){const n=e.error;return typeof(n==null?void 0:n.message)=="string"?n.message:null}async function xt(e,n){const t=an(e),a=At(e.arguments);try{switch(t){case"listFileset":{const s=await n.listFileset();return R(s)}case"readFile":{const s=await n.readFile(C(a,"path"));return R(s)}case"setFileContent":return await n.setFileContent(C(a,"path"),C(a,"content")),R("ok");case"replaceFilePart":return await n.replaceFilePart(C(a,"path"),C(a,"search"),C(a,"replacement"),It(a,"replaceAll",!1)),R("ok");case"deleteFile":return await n.deleteFile(C(a,"path")),R("ok");case"evalInApp":{const s=await n.evalInApp(C(a,"code"));return R(s)}case"getAppDiagnostics":{const s=await n.getAppDiagnostics();return R(s)}case"runAppAndCollectDiagnostics":{const s=await n.runAppAndCollectDiagnostics();return R(s)}default:return Ve(`Unknown tool: ${t}`)}}catch(s){return Ve(s instanceof Error?s.message:String(s))}}function At(e){if(e===void 0)return{};if(typeof e=="object"&&e!==null)return e;if(typeof e!="string")throw new Error("Invalid tool arguments value.");try{const n=JSON.parse(e);if(typeof n!="object"||n===null)throw new Error("Tool arguments must be a JSON object.");return n}catch{throw new Error("Invalid tool arguments JSON.")}}function Tt(e){return e.type==="function_call"}function an(e){if(typeof e.name!="string"||e.name.trim()==="")throw new Error("Tool call missing function name.");return e.name}function kt(e){if(typeof e.call_id!="string"||e.call_id.trim()==="")throw new Error("Tool call missing call_id.");return e.call_id}function Lt(e){return typeof e.output_text=="string"&&e.output_text.trim()!==""?e.output_text.trim():Array.isArray(e.output)?e.output.filter(t=>t.type==="message").flatMap(t=>t.content??[]).map(t=>t.text??"").map(t=>t.trim()).filter(t=>t!=="").join(`
...
<\/script>`;function Ot(e,n,t){if(n.length===0){e.removeAttribute("srcdoc"),e.src="about:blank";return}const a=n.find(i=>i.name==="index.html")??n.find(i=>i.name.endsWith(".html"))??null;if(a===null){e.removeAttribute("srcdoc"),e.src="about:blank";return}let s=a.content;const o=n.find(i=>i.name==="style.css")??n.find(i=>i.name.endsWith(".css"))??null;o!==null&&(s=s.replace(/<link[^>]+href=["']style\.css["'][^>]*>/gi,`<style>${o.content}</style>`),s=s.replace(/<link[^>]+href=["']([^"']+\.css)["'][^>]*>/gi,`<style>${o.content}</style>`));for(const i of n){if(!i.name.endsWith(".js"))continue;const p=i.name.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");s=s.replace(new RegExp(`(<script[^>]*?)\\s+src=["']${p}["']([^>]*)><\\/script>`,"gi"),(v,E,b)=>{const h=`${String(E)} ${String(b)}`;return/type=["']module["']/i.test(h)?`<script type="module">${i.content}<\/script>`:`<script>${i.content}<\/script>`})}s=Nt(s,n),s=Dt(s,t),s=Pt(s),e.srcdoc=s}async function Ge(e,n){const t=await pn(e,Ie,{code:n},on);if(t.ok===!0)return t.value;throw new Error(typeof t.error=="string"?t.error:"Unknown preview evaluation error.")}async function dn(e){const n=await pn(e,ln,{},cn);if(n.ok!==!0)throw new Error(typeof n.error=="string"?n.error:"Failed to read preview diagnostics.");return n.diagnostics??{logs:[],errors:[]}}async function pn(e,n,t,a){const s=e.contentWindow;if(s===null)throw new Error("Preview frame is not available.");const o=crypto.randomUUID();return new Promise((i,p)=>{const v=window.setTimeout(()=>{b(),p(new Error("Timed out waiting for app evaluation result."))},5e3),E=h=>{if(h.source!==s)return;const c=h.data;c.type!==a||c.id!==o||(b(),i(c))};function b(){window.clearTimeout(v),window.removeEventListener("message",E)}window.addEventListener("message",E),s.postMessage({type:n,id:o,...t},"*")})}function Pt(e){return e.includes(Ie)?e:e.includes("</body>")?e.replace("</body>",`${qe}</body>`):`${e}
...
${t}`):`${t}
${e}`}function x(){return crypto.randomUUID()}function T(){return new Date().toISOString()}function l(e){const n=document.getElementById(e);if(n===null)throw new Error(`Missing element #${e}`);return n}const Mt=l("app-workspace"),Ft=l("first-app-setup"),Oe=l("first-api-key-input"),J=l("first-app-name-input"),_t=l("btn-create-first-app"),Bt=l("btn-create-todo-sample"),Pe=l("panels"),Ke=l("panel-chat"),He=l("panel-editor"),D=l("app-select"),P=l("file-select"),te=l("file-content"),z=l("chat-messages"),ze=l("chat-progress"),we=l("chat-input"),Ee=l("btn-generate"),$t=l("btn-run"),Ut=l("btn-refresh-preview"),V=l("preview-frame"),Jt=l("btn-new-app"),Vt=l("btn-import"),qt=l("btn-project-settings"),Gt=l("btn-export"),Wt=l("btn-settings"),Kt=l("btn-agent-instructions"),Se=l("btn-toggle-chat"),je=l("btn-toggle-files"),se=l("settings-modal"),Ht=l("btn-close-settings"),zt=l("btn-save-settings"),Yt=l("btn-cancel-settings"),xe=l("api-key-input"),un=l("model-select"),mn=l("theme-select"),fn=l("font-size-input"),gn=l("max-tool-steps-input"),Q=l("name-modal"),Qt=l("name-modal-title"),ne=l("app-name-input"),de=l("btn-confirm-name"),Xt=l("btn-cancel-name"),Zt=l("btn-close-name-modal"),ae=l("project-settings-modal"),U=l("project-name-input"),es=l("btn-save-project-settings"),ns=l("btn-delete-project"),ts=l("btn-close-project-settings"),ss=l("btn-close-project-settings-x"),re=l("import-file"),oe=l("agent-instructions-modal"),Ae=l("agent-instructions-text"),as=l("btn-close-agent-instructions"),rs=l("btn-close-agent-instructions-2"),os=l("btn-copy-agent-instructions"),vn="asljs-app-builder-settings",bn="light",Te=14,hn="__new__",yn="__import__";function M(){try{const e=localStorage.getItem(vn)??"{}";return JSON.parse(e)}catch{return{}}}function Ne(e){localStorage.setItem(vn,JSON.stringify(e))}function pe(){return M().apiKey??""}function wn(){const e=M().model;return e==="gpt-5.3-codex"||e==="gpt-5.4"?e:bt}function En(){const e=M().maxToolSteps;if(!Number.isFinite(e))return Y;const n=Math.floor(e);return n<1?Y:n}function Sn(){return M().theme==="light"?"light":bn}function jn(){const e=M().fontSize;if(!Number.isFinite(e))return Te;const n=Math.floor(e);return n<12||n>20?Te:n}function xn(){document.body.dataset.theme=Sn(),document.documentElement.style.fontSize=`${jn()}px`}function is(){if(r.currentAppId===null)throw new Error("No active app. Create or open an app first.");return r.currentAppId}function ke(e){const n=e.trim().replace(/\\/g,"/").replace(/^\.\//,"").replace(/^\/+/,"");if(n==="")throw new Error("Path cannot be empty.");if(n.includes(".."))throw new Error("Parent path segments are not allowed.");return n}function ue(e){const n=ke(e),t=r.files.find(a=>ke(a.name).toLowerCase()===n.toLowerCase());return(t==null?void 0:t.name)??null}async function An(){return[...r.files].map(e=>e.name).sort((e,n)=>e.localeCompare(n))}async function Ce(e){const n=ue(e),t=n===null?void 0:r.files.find(a=>a.name===n);if(t===void 0)throw new Error(`File not found: ${e}`);return t.content}async function Re(e,n){const t=is(),a=ke(e),s=ue(a),o=r.files.find(p=>p.name===(s??a));if(o!==void 0){const p={...o,content:n};await ye(p),r.files=r.files.map(v=>v.id===p.id?p:v),r.activeFileName=p.name;return}const i={id:x(),appId:t,name:a,content:n};await ye(i),r.files=[...r.files,i],r.activeFileName=i.name}async function Tn(e){var s;const n=ue(e),t=n===null?void 0:r.files.find(o=>o.name===n);if(t===void 0)return;await Hn(t.id);const a=r.files.filter(o=>o.id!==t.id);r.files=a,r.activeFileName===e&&(r.activeFileName=((s=a[0])==null?void 0:s.name)??null)}async function kn(e,n,t,a=!1){if(n==="")throw new Error("Search text cannot be empty.");const s=ue(e);if(s===null)throw new Error(`File not found: ${e}`);const o=await Ce(s);if(!o.includes(n))throw new Error(`Search text not found in ${s}.`);let i=o;if(a)i=o.split(n).join(t);else{const p=o.indexOf(n);if(o.indexOf(n,p+n.length)!==-1)throw new Error("Search text is ambiguous. Use replaceAll=true or provide a more specific search block.");i=o.slice(0,p)+t+o.slice(p+n.length)}await Re(s,i)}async function Ln(e){if(r.files.length===0)throw new Error("No files available to run.");q();try{return await Ge(V,e)}catch{return q(),Ge(V,e)}}async function In(){return dn(V)}async function On(){return q(),await ls(350),dn(V)}function ls(e){return new Promise(n=>{window.setTimeout(n,e)})}function ie(){D.replaceChildren();const e=[...r.apps].sort((a,s)=>s.updatedAt.localeCompare(a.updatedAt));for(const a of e){const s=document.createElement("option");s.value=a.id,s.textContent=a.name,D.appendChild(s)}if(e.length>0){const a=document.createElement("option");a.value="__separator__",a.textContent="────────",a.disabled=!0,D.appendChild(a)}const n=document.createElement("option");n.value=hn,n.textContent="New...",D.appendChild(n);const t=document.createElement("option");t.value=yn,t.textContent="Import...",D.appendChild(t),r.currentAppId!==null&&(D.value=r.currentAppId)}function Pn(){Mt.classList.remove("hidden");const e=r.currentAppId!==null&&r.apps.some(n=>n.id===r.currentAppId);if(Ft.classList.toggle("hidden",e),Pe.classList.toggle("hidden",!e),!e){Oe.value=pe(),J.value="";return}De(),Me()}async function Nn(){const e=J.value.trim();if(e===""){J.focus();return}const n=Oe.value.trim();if(n!==""){const a=M();a.apiKey=n,Ne(a)}const t={id:x(),name:e,createdAt:T(),updatedAt:T()};await G(t),r.apps=[...r.apps,t],await W(t.id)}async function cs(){const e=J.value.trim(),n=e===""?"TODO Sample":e,t=Oe.value.trim();if(t!==""){const i=M();i.apiKey=t,Ne(i)}const a=x(),s={id:a,name:n,createdAt:T(),updatedAt:T()},o=ds(a);await G(s),await tn(a,o),r.apps=[...r.apps,s],await W(a)}function ds(e){return[{id:x(),appId:e,name:"index.html",content:`<!doctype html>
<html lang="en">
<head>
  <meta charset="UTF-8" />
...
</html>`},{id:x(),appId:e,name:"style.css",content:`:root {
...
li {
  margin: 0.25rem 0;
}`},{id:x(),appId:e,name:"app.js",content:`const form = document.getElementById('todo-form');
...
render();`},{id:x(),appId:e,name:"package.json",content:`{
  "name": "todo-sample",
  "version": "0.1.0",
  "private": true,
  "type": "module",
...
}`},{id:x(),appId:e,name:"README.md",content:`# TODO Sample
