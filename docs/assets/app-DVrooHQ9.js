(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function t(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(r){if(r.ep)return;r.ep=!0;const a=t(r);fetch(r.href,a)}})();class wn extends Error{constructor(n,t,s,r,a){super(n),this.name="ListenerError",this.error=t,this.object=s,this.event=r,this.listener=a}}function B(e){if(typeof e!="string"&&typeof e!="symbol")throw new TypeError("Expect event to be a string or symbol.")}function ne(e){return typeof e=="function"}function Ie(e){if(ne(e))return e}function qe(e){return typeof e=="object"&&e!==null}function le(e){if(!ne(e))throw new TypeError("Expect a function.")}const jn=(e=Object.create(null),n={})=>{if(!qe(e)&&!ne(e))throw new TypeError("Expect an object or a function.");for(const l of["on","once","off","emit","emitAsync","has"])if(l in e)throw new Error(`Method "${l}" already exists.`);const{strict:t=!1,trace:s=null,error:r=null}=n,a=Ie(s)??null,i=Ie(r)??null,u=e!==R,g=(l,p)=>{a==null||a(l,p),u&&R.emit(l,p)};g("new",{object:e});const j=new Set,v=new Map,y={enumerable:!1,configurable:!0,writable:!0};return Object.defineProperties(e,{on:Object.assign({value:x},y),once:Object.assign({value:E},y),off:Object.assign({value:h},y),emit:Object.assign({value:k},y),emitAsync:Object.assign({value:T},y),has:Object.assign({value:A},y)}),e;function c(l,p){let f=v.get(l);f||v.set(l,f=new Set),f.add(p)}function b(l,p){const f=v.get(l);if(!f)return!1;const w=f.delete(p);return f.size===0&&v.delete(l),w}function m(l,p,f){const w={error:f,object:e,event:l,listener:p};if(i==null||i(w),e===R&&l==="error")throw new wn("Error in a global error listener.",f,e,l,p);R.emit("error",w)}function x(l,p){B(l),le(p),g("on",{object:e,event:l,listener:p}),c(l,p);let f=!0;return()=>f?(f=!1,b(l,p)):!1}function E(l,p){B(l),le(p);const f=x(l,(...w)=>{f(),p(...w)});return f}function h(l,p){return B(l),le(p),g("off",{object:e,event:l,listener:p}),b(l,p)}function A(l){var p;return B(l),(((p=v.get(l))==null?void 0:p.size)??0)>0}function k(l,...p){B(l);const f=v.get(l)||j;if(g("emit",{object:e,listeners:[...f],event:l,args:p}),f.size!==0)for(const w of f)try{w(...p)}catch(O){if(m(l,w,O),t)throw O}}async function T(l,...p){B(l);const f=v.get(l)||j;if(g("emitAsync",{object:e,listeners:[...f],event:l,args:p}),f.size===0)return;const w=[...f].map(async O=>{try{await O(...p)}catch(Te){if(m(l,O,Te),t)throw Te}});await(t?Promise.all(w):Promise.allSettled(w))}},R=jn;R(R);function En(e){return!qe(e)&&!ne(e)?!1:typeof e.on=="function"}function We(e){if(En(e))return e}function L(e){return typeof e=="function"}function we(e){return typeof e=="object"&&e!==null}function Ge(e){if(!L(e))throw new TypeError("Expect a function.")}function pe(e){if(e.trim()==="")throw new TypeError("Expect watch path to be a non-empty string.");const n=e.split(".");for(const t of n)if(t.trim()==="")throw new TypeError("Expect watch path segments to be non-empty.");return e.split(".").map(t=>t.trim()).filter(t=>t!=="")}function xn(e,n){const t=pe(n);if(t.length===0)return;let s=e;for(const r of t){if(!we(s)||!(r in s))return;s=s[r]}return s}const ze=(e,n,t)=>{if(Array.isArray(e))throw new TypeError("Watching arrays is not supported.");Ge(t);const s=typeof n=="string"?[n]:n;if(!Array.isArray(s))throw new TypeError("Expect properties to be a string or an array of strings.");for(const i of s){if(typeof i!="string")throw new TypeError("Expect properties to be a string or an array of strings.");pe(i)}const r=()=>s.map(i=>xn(e,i)),a=[];for(const i of s){const u=pe(i);let g=null;const j=()=>{const v=[],y=(c,b)=>{if(!we(c)||b>=u.length)return;const m=u[b],x=We(c);if(x){const E=x.on(`set:${m}`,()=>{t(...r()),b<u.length-1&&g&&(g(),g=j())});v.push(E)}b<u.length-1&&y(c[m],b+1)};return y(e,0),()=>v.reduce((c,b)=>b()||c,!1)};g=j(),a.push(()=>g?g():!1)}return t(...r()),()=>a.reduce((i,u)=>u()||i,!1)};function Sn(e,n){"watch"in e||Object.defineProperty(e,"watch",{configurable:!0,writable:!0,enumerable:!1,value(t,s){return n(typeof t=="string"?this:this,t,s)}})}function Oe(e,n){return Object.prototype.hasOwnProperty.call(e,n)}function ce(e){if(typeof e=="symbol")return!1;const n=typeof e=="number"?e:Number(e);return!Number.isInteger(n)||n<0||n>=4294967295?!1:typeof e=="number"||e===String(n)}function An(e){return We(e)?L(e.emit):!1}const He=(e,n={})=>{const{eventful:t=R,trace:s=null,shallow:r=!1}=n;Ge(t);const a=te.options,i=new WeakMap,u=c=>{if(r||!we(c)||An(c))return c;if(i.has(c))return i.get(c);const b=He(c,{eventful:t,trace:s,shallow:r});return i.set(c,b),b},g=c=>{if(!r){if(Array.isArray(c)){for(let b=0;b<c.length;b++)c[b]=u(c[b]);return}for(const b of Reflect.ownKeys(c))Oe(c,b)&&(c[b]=u(c[b]))}},j=c=>{const b=Array.isArray(c);g(c),Sn(c,ze);let m;const x=new Proxy(c,{set(E,h,A,k){const T=b&&ce(h),l=Reflect.get(E,h,k),p=Reflect.set(E,h,u(A),k);if(m&&p){const f=Reflect.get(E,h,k);if(!Object.is(l,f)){const w=T?{index:Number(h),value:f,previous:l}:{property:h,value:f,previous:l},O=s||a.trace;m.emit(`set:${String(h)}`,w),L(O)&&O(m,"set",w),m.emit("set",w)}}return p},deleteProperty(E,h){const A=b&&ce(h),k=Oe(E,h),T=k?E[h]:void 0,l=Reflect.deleteProperty(E,h);if(m&&l&&k){const p=A?{index:Number(h),previous:T}:{property:h,previous:T},f=s||a.trace;m.emit(`delete:${String(h)}`,p),L(f)&&f(m,"delete",p),m.emit("delete",p)}return l},defineProperty(E,h,A){const k=Object.getOwnPropertyDescriptor(E,h)??null,T=Object.prototype.hasOwnProperty.call(A,"value")?{...A,value:u(A.value)}:A,l=Reflect.defineProperty(E,h,T),p=b&&(h==="length"||ce(h));if(m&&!p&&l){const f={property:h,descriptor:T,previous:k},w=s||a.trace;m.emit(`define:${String(h)}`,f),L(w)&&w(m,"define",f),m.emit("define",f)}return l}});return m=L(c==null?void 0:c.emit)?x:t(x),m},v=s||a.trace;if(Array.isArray(e)){const c=j(e);return L(v)&&v(c,"new"),c}if(e!==null&&typeof e=="object"){const c=j(e);return L(v)&&v(c,"new",{object:c}),c}const y=t({get value(){return e},set value(c){if(Object.is(c,e))return;const b=e;e=c;const m={property:"value",value:e,previous:b};y.emit("set:value",m),L(v)&&v(y,"set",m),y.emit("set",m)}});return L(v)&&v(y,"new",{object:y}),y},te=He;te.options={trace:null};te.watch=ze;const o=te({apps:[],currentAppId:null,files:[],activeFileName:null,generating:!1,error:null});function S(e){return new Promise((n,t)=>{e.addEventListener("success",()=>{n(e.result)}),e.addEventListener("error",()=>{t(e.error??new Error("IndexedDB request failed"))})})}function kn(e,n){return new Promise((t,s)=>{const r=indexedDB.open(e,n.length);r.addEventListener("upgradeneeded",a=>{const i=n.slice(a.oldVersion-1,a.newVersion??n.length-1);for(const u of i)u(r.result)}),r.addEventListener("success",()=>{t(r.result)}),r.addEventListener("blocked",()=>{s(new Error("Database opening is blocked"))}),r.addEventListener("error",()=>{s(r.error??new Error("Failed to open database"))})})}const Ln="asljs-app-builder";let H=null;async function D(){return H!==null||(H=await kn(Ln,[e=>{e.createObjectStore("apps",{keyPath:"id"}),e.createObjectStore("files",{keyPath:"id"}).createIndex("byAppId","appId",{unique:!1})}])),H}async function Tn(){const n=(await D()).transaction("apps","readonly");return S(n.objectStore("apps").getAll())}async function re(e){const t=(await D()).transaction("apps","readwrite");await S(t.objectStore("apps").put(e))}async function In(e){const t=(await D()).transaction(["apps","files"],"readwrite");await S(t.objectStore("apps").delete(e));const s=t.objectStore("files"),r=await S(s.index("byAppId").getAllKeys(e));for(const a of r)await S(s.delete(a))}async function On(e){const t=(await D()).transaction("files","readonly");return S(t.objectStore("files").index("byAppId").getAll(e))}async function ue(e){const t=(await D()).transaction("files","readwrite");await S(t.objectStore("files").put(e))}async function Nn(e){const t=(await D()).transaction("files","readwrite");await S(t.objectStore("files").delete(e))}async function Pn(e,n){const r=(await D()).transaction("files","readwrite").objectStore("files"),a=await S(r.index("byAppId").getAllKeys(e));for(const i of a)await S(r.delete(i));for(const i of n)await S(r.put(i))}const Cn=`# observable\r
\r
...
`,Hn=[{type:"function",name:"listFileset",description:"List all file paths in the virtual filesystem.",parameters:{type:"object",properties:{},required:[],additionalProperties:!1},strict:!0},{type:"function",name:"readFile",description:"Read the full text content of a file.",parameters:{type:"object",properties:{path:{type:"string"}},required:["path"],additionalProperties:!1},strict:!0},{type:"function",name:"setFileContent",description:"Create or fully replace file content.",parameters:{type:"object",properties:{path:{type:"string"},content:{type:"string"}},required:["path","content"],additionalProperties:!1},strict:!0},{type:"function",name:"replaceFilePart",description:"Replace part of a file by exact search string.",parameters:{type:"object",properties:{path:{type:"string"},search:{type:"string"},replacement:{type:"string"},replaceAll:{type:"boolean"}},required:["path","search","replacement","replaceAll"],additionalProperties:!1},strict:!0},{type:"function",name:"deleteFile",description:"Delete a file from the virtual filesystem.",parameters:{type:"object",properties:{path:{type:"string"}},required:["path"],additionalProperties:!1},strict:!0},{type:"function",name:"evalInApp",description:"Evaluate JavaScript in the running app document context.",parameters:{type:"object",properties:{code:{type:"string"}},required:["code"],additionalProperties:!1},strict:!0}],Kn="https://api.openai.com/v1/responses",Yn=G(Jn,"asljs-observable"),Qn=G(qn,"asljs-eventful"),Xn=G(Wn,"asljs-data-binding"),Zn=G(Gn,"asljs-components"),et=G(zn,"asljs-dali"),Ke=ot(),nt="gpt-5.3-codex",q=20;function tt(){return Ke}const rt=12;async function st(e,n,t,s,r){var j;let a,i=e,u=at(r==null?void 0:r.initialToolStepLimit),g=0;for(;;){if(await U(r,`Step ${g+1}: requesting assistant response...`),g>=u){if(!(await((j=r==null?void 0:r.onToolStepLimit)==null?void 0:j.call(r,{stepsCompleted:g,stepLimit:u}))??!1))throw new Error("AI exceeded maximum tool steps without completing.");u+=rt,await U(r,`Extended step limit to ${u}. Continuing...`)}const v=await fetch(Kn,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${n}`},body:JSON.stringify({model:t,instructions:Ke,temperature:.1,previous_response_id:a,input:i,tools:Hn})});if(!v.ok){const m=await v.json().catch(()=>({})),x=it(m)??`OpenAI API error: ${v.status}`;throw new Error(x)}const y=await v.json();if(!Array.isArray(y.output))throw new Error("AI returned an unexpected response format.");const c=y.output.filter(dt);if(c.length===0){await U(r,`Completed in ${g+1} step(s). Finalizing summary...`);const m=ut(y);return{summary:m===""?"Completed tool-based update.":m}}const b=[];for(const m of c){await U(r,`Step ${g+1}: running ${Ye(m)}...`);const x=await lt(m,s);b.push({type:"function_call_output",call_id:pt(m),output:x})}await U(r,`Step ${g+1}: submitted ${b.length} tool result(s).`),a=typeof y.id=="string"?y.id:a,i=b,g+=1}}function at(e){if(!Number.isFinite(e))return q;const n=Math.floor(e);return n>=1?n:q}async function U(e,n){(e==null?void 0:e.onProgress)!==void 0&&await Promise.resolve(e.onProgress(n))}function ot(){const e=`
      Latest ASLJS package versions to use:
      - asljs-eventful@${Qn}
      - asljs-observable@${Yn}
      - asljs-data-binding@${Xn}
      - asljs-components@${Zn}
      - asljs-dali@${et}
    `,n=[V("eventful",Rn,$n),V("observable",Cn,Bn),V("data-binding",Fn,_n),V("components",Mn,Un),V("dali",Dn,Vn)].join(`
...
... [truncated]`}function G(e,n){try{return JSON.parse(e).version??"latest"}catch{return console.warn(`Failed to parse package metadata for ${n}.`),"latest"}}function it(e){const n=e.error;return typeof(n==null?void 0:n.message)=="string"?n.message:null}async function lt(e,n){const t=Ye(e),s=ct(e.arguments);try{switch(t){case"listFileset":{const r=await n.listFileset();return $(r)}case"readFile":{const r=await n.readFile(N(s,"path"));return $(r)}case"setFileContent":return await n.setFileContent(N(s,"path"),N(s,"content")),$("ok");case"replaceFilePart":return await n.replaceFilePart(N(s,"path"),N(s,"search"),N(s,"replacement"),ft(s,"replaceAll",!1)),$("ok");case"deleteFile":return await n.deleteFile(N(s,"path")),$("ok");case"evalInApp":{const r=await n.evalInApp(N(s,"code"));return $(r)}default:return Pe(`Unknown tool: ${t}`)}}catch(r){return Pe(r instanceof Error?r.message:String(r))}}function ct(e){if(e===void 0)return{};if(typeof e=="object"&&e!==null)return e;if(typeof e!="string")throw new Error("Invalid tool arguments value.");try{const n=JSON.parse(e);if(typeof n!="object"||n===null)throw new Error("Tool arguments must be a JSON object.");return n}catch{throw new Error("Invalid tool arguments JSON.")}}function dt(e){return e.type==="function_call"}function Ye(e){if(typeof e.name!="string"||e.name.trim()==="")throw new Error("Tool call missing function name.");return e.name}function pt(e){if(typeof e.call_id!="string"||e.call_id.trim()==="")throw new Error("Tool call missing call_id.");return e.call_id}function ut(e){return typeof e.output_text=="string"&&e.output_text.trim()!==""?e.output_text.trim():Array.isArray(e.output)?e.output.filter(t=>t.type==="message").flatMap(t=>t.content??[]).map(t=>t.text??"").map(t=>t.trim()).filter(t=>t!=="").join(`
`):""}function N(e,n){const t=e[n];if(typeof t!="string")throw new Error(`Tool argument "${n}" must be a string.`);return t}function ft(e,n,t){const s=e[n];if(s===void 0)return t;if(typeof s!="boolean")throw new Error(`Tool argument "${n}" must be a boolean.`);return s}function $(e){return Qe({ok:!0,value:e})}function Pe(e){return Qe({ok:!1,error:e})}function Qe(e){try{return JSON.stringify(e)}catch{return'{"ok":false,"error":"Failed to serialize tool result."}'}}const je="asljs-app-builder:eval-request",Xe="asljs-app-builder:eval-response",Ce=`<script>
(() => {
  const REQUEST = '${je}';
  const RESPONSE = '${Xe}';
...
<\/script>`;function mt(e,n){if(n.length===0){e.removeAttribute("srcdoc"),e.src="about:blank";return}const t=n.find(a=>a.name==="index.html")??n.find(a=>a.name.endsWith(".html"))??null;if(t===null){e.removeAttribute("srcdoc"),e.src="about:blank";return}let s=t.content;const r=n.find(a=>a.name==="style.css")??n.find(a=>a.name.endsWith(".css"))??null;r!==null&&(s=s.replace(/<link[^>]+href=["']style\.css["'][^>]*>/gi,`<style>${r.content}</style>`),s=s.replace(/<link[^>]+href=["']([^"']+\.css)["'][^>]*>/gi,`<style>${r.content}</style>`));for(const a of n){if(!a.name.endsWith(".js"))continue;const i=a.name.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");s=s.replace(new RegExp(`(<script[^>]*?)\\s+src=["']${i}["']([^>]*)><\\/script>`,"gi"),(u,g,j)=>{const v=`${String(g)} ${String(j)}`;return/type=["']module["']/i.test(v)?`<script type="module">${a.content}<\/script>`:`<script>${a.content}<\/script>`})}s=bt(s,n),s=vt(s),e.srcdoc=s}async function Re(e,n){const t=e.contentWindow;if(t===null)throw new Error("Preview frame is not available.");const s=crypto.randomUUID();return new Promise((r,a)=>{const i=window.setTimeout(()=>{g(),a(new Error("Timed out waiting for app evaluation result."))},5e3),u=j=>{if(j.source!==t)return;const v=j.data;if(!(v.type!==Xe||v.id!==s)){if(g(),v.ok===!0){r(v.value);return}a(new Error(v.error??"Unknown preview evaluation error."))}};function g(){window.clearTimeout(i),window.removeEventListener("message",u)}window.addEventListener("message",u),t.postMessage({type:je,id:s,code:n},"*")})}function vt(e){return e.includes(je)?e:e.includes("</body>")?e.replace("</body>",`${Ce}</body>`):`${e}
${Ce}`}function bt(e,n){if(/type=["']importmap["']/i.test(e))return e;const t=n.find(i=>i.name==="package.json")??null,s=gt(t==null?void 0:t.content),r=Object.fromEntries(s.map(([i,u])=>[i,`https://esm.sh/${i}@${u}?bundle`]));if(Object.keys(r).length===0)return e;const a=`<script type="importmap">${JSON.stringify({imports:r})}<\/script>`;return/<head[^>]*>/i.test(e)?e.replace(/<head[^>]*>/i,i=>`${i}
${a}`):`${a}
${e}`}function gt(e){if(e===void 0)return Fe();try{const n=JSON.parse(e),t={...n.dependencies??{},...n.devDependencies??{}};return["asljs-eventful","asljs-observable","asljs-data-binding","asljs-components","asljs-dali"].map(a=>[a,ht(t[a])])}catch{return Fe()}}function ht(e){if(typeof e!="string"||e.trim()==="")return"latest";const n=e.trim().replace(/^[~^<>=\s]+/,"");return n===""?"latest":n}function Fe(){return[["asljs-eventful","latest"],["asljs-observable","latest"],["asljs-data-binding","latest"],["asljs-components","latest"],["asljs-dali","latest"]]}function K(){return crypto.randomUUID()}function F(){return new Date().toISOString()}function d(e){const n=document.getElementById(e);if(n===null)throw new Error(`Missing element #${e}`);return n}const Me=d("app-list"),De=d("empty-state"),Be=d("app-workspace"),yt=d("app-name-display"),wt=d("panels"),$e=d("panel-editor"),I=d("file-select"),Y=d("file-content"),J=d("chat-messages"),_e=d("chat-progress"),fe=d("chat-input"),me=d("btn-generate"),jt=d("btn-run"),Et=d("btn-refresh-preview"),Q=d("preview-frame"),xt=d("btn-new-app"),St=d("btn-new-app-2"),At=d("btn-rename"),kt=d("btn-delete-app"),Lt=d("btn-export"),Tt=d("btn-settings"),It=d("btn-agent-instructions"),ve=d("btn-toggle-apps"),Ue=d("apps-content"),be=d("btn-toggle-files"),X=d("settings-modal"),Ot=d("btn-close-settings"),Nt=d("btn-save-settings"),Pt=d("btn-cancel-settings"),ge=d("api-key-input"),Ze=d("model-select"),en=d("theme-select"),nn=d("font-size-input"),tn=d("max-tool-steps-input"),M=d("name-modal"),rn=d("name-modal-title"),P=d("app-name-input"),z=d("btn-confirm-name"),Ct=d("btn-cancel-name"),Rt=d("btn-close-name-modal"),Z=d("import-file"),ee=d("agent-instructions-modal"),he=d("agent-instructions-text"),Ft=d("btn-close-agent-instructions"),Mt=d("btn-close-agent-instructions-2"),Dt=d("btn-copy-agent-instructions"),sn="asljs-app-builder-settings",Bt="dark",ye=14;function _(){try{const e=localStorage.getItem(sn)??"{}";return JSON.parse(e)}catch{return{}}}function $t(e){localStorage.setItem(sn,JSON.stringify(e))}function an(){return _().apiKey??""}function on(){const e=_().model;return e==="gpt-5.3-codex"||e==="gpt-5.4"?e:nt}function ln(){const e=_().maxToolSteps;if(!Number.isFinite(e))return q;const n=Math.floor(e);return n<1?q:n}function cn(){return _().theme==="light"?"light":"dark"}function dn(){const e=_().fontSize;if(!Number.isFinite(e))return ye;const n=Math.floor(e);return n<12||n>20?ye:n}function pn(){document.body.dataset.theme=cn(),document.documentElement.style.fontSize=`${dn()}px`}function _t(){if(o.currentAppId===null)throw new Error("No active app. Create or open an app first.");return o.currentAppId}async function un(){return[...o.files].map(e=>e.name).sort((e,n)=>e.localeCompare(n))}async function Ee(e){const n=o.files.find(t=>t.name===e);if(n===void 0)throw new Error(`File not found: ${e}`);return n.content}async function xe(e,n){const t=_t(),s=o.files.find(a=>a.name===e);if(s!==void 0){const a={...s,content:n};await ue(a),o.files=o.files.map(i=>i.id===a.id?a:i),o.activeFileName=a.name;return}const r={id:K(),appId:t,name:e,content:n};await ue(r),o.files=[...o.files,r],o.activeFileName=r.name}async function fn(e){var s;const n=o.files.find(r=>r.name===e);if(n===void 0)return;await Nn(n.id);const t=o.files.filter(r=>r.id!==n.id);o.files=t,o.activeFileName===e&&(o.activeFileName=((s=t[0])==null?void 0:s.name)??null)}async function mn(e,n,t,s=!1){if(n==="")throw new Error("Search text cannot be empty.");const r=await Ee(e);if(!r.includes(n))throw new Error(`Search text not found in ${e}.`);let a=r;if(s)a=r.split(n).join(t);else{const i=r.indexOf(n);if(r.indexOf(n,i+n.length)!==-1)throw new Error("Search text is ambiguous. Use replaceAll=true or provide a more specific search block.");a=r.slice(0,i)+t+r.slice(i+n.length)}await xe(e,a)}async function vn(e){if(o.files.length===0)throw new Error("No files available to run.");W();try{return await Re(Q,e)}catch{return W(),Re(Q,e)}}function bn(){Me.replaceChildren();const e=[...o.apps].sort((n,t)=>t.updatedAt.localeCompare(n.updatedAt));for(const n of e){const t=document.createElement("div");t.className="app-item"+(n.id===o.currentAppId?" active":""),t.dataset.id=n.id;const s=document.createElement("span");s.className="app-item-name",s.textContent=n.name,t.appendChild(s),t.addEventListener("click",()=>{ae(n.id)}),Me.appendChild(t)}}function gn(){const e=o.apps.find(n=>n.id===o.currentAppId);if(e===void 0){De.classList.remove("hidden"),Be.classList.add("hidden");return}De.classList.add("hidden"),Be.classList.remove("hidden"),yt.textContent=e.name,Se(),Ae()}function Se(){if(I.replaceChildren(),o.files.length===0){const n=document.createElement("option");n.value="",n.textContent="No files",I.appendChild(n),I.value="",I.disabled=!0;return}for(const n of o.files){const t=document.createElement("option");t.value=n.name,t.textContent=n.name,I.appendChild(t)}const e=o.activeFileName??o.files[0].name;I.value=e,I.disabled=!1}function Ae(){const e=o.files.find(n=>n.name===o.activeFileName);Y.value=(e==null?void 0:e.content)??"",Y.disabled=e===void 0}function Ve(e){o.generating=e,me.disabled=e,me.innerHTML=e?'<span class="spinner"></span> Generating…':"Generate"}function de(e,n){_e.textContent=e,_e.classList.toggle("hidden",!n)}function C(e,n){const t=document.createElement("div");t.className=`chat-msg ${e}`;const s=document.createElement("div");s.className="chat-msg-role",s.textContent=e==="user"?"You":"Assistant";const r=document.createElement("div");r.className="chat-bubble",r.textContent=n,t.appendChild(s),t.appendChild(r),J.appendChild(t),J.scrollTop=J.scrollHeight}async function se(){if(o.activeFileName===null||o.currentAppId===null)return;const e=o.files.find(t=>t.name===o.activeFileName);if(e===void 0)return;const n=Y.value;e.content!==n&&(e.content=n,await ue(e))}async function ae(e){var t;o.currentAppId=e;const n=await On(e);o.files=n,o.activeFileName=((t=n[0])==null?void 0:t.name)??null,J.replaceChildren()}function hn(){rn.textContent="New App",P.value="",M.classList.remove("hidden"),P.focus(),z.onclick=async()=>{const e=P.value.trim();if(e==="")return;M.classList.add("hidden");const n={id:K(),name:e,createdAt:F(),updatedAt:F()};await re(n),o.apps=[...o.apps,n],await ae(n.id)}}function ke(){M.classList.add("hidden"),z.onclick=null}function Ut(){const e=o.apps.find(n=>n.id===o.currentAppId);e!==void 0&&(rn.textContent="Rename App",P.value=e.name,M.classList.remove("hidden"),P.focus(),P.select(),z.onclick=async()=>{const n=P.value.trim();if(n==="")return;M.classList.add("hidden");const t={...e,name:n,updatedAt:F()};await re(t),o.apps=o.apps.map(s=>s.id===e.id?t:s)})}async function Vt(){const e=o.apps.find(n=>n.id===o.currentAppId);e!==void 0&&confirm(`Delete "${e.name}"? This cannot be undone.`)&&(await In(e.id),o.apps=o.apps.filter(n=>n.id!==e.id),o.currentAppId=null,o.files=[],o.activeFileName=null,J.replaceChildren(),Q.src="about:blank")}async function yn(){const e=fe.value.trim();if(e==="")return;const n=an();if(n===""){C("assistant","No OpenAI API key set. Open Settings (⚙) to add your key. Generation is optional — you can also create files manually.");return}if(o.currentAppId===null){C("assistant","Please create or open an app first.");return}fe.value="",C("user",e),Ve(!0),de("Starting generation...",!0);try{const t=on(),s=ln(),r=await st(e,n,t,{listFileset:un,readFile:Ee,setFileContent:xe,replaceFilePart:mn,deleteFile:fn,evalInApp:vn},{initialToolStepLimit:s,onToolStepLimit:async({stepsCompleted:i})=>confirm(`AI reached ${i} tool steps without finishing. Continue for 12 more steps?`),onProgress:i=>{de(i,!0)}}),a=o.apps.find(i=>i.id===o.currentAppId);if(a!==void 0){const i={...a,updatedAt:F()};await re(i),o.apps=o.apps.map(u=>u.id===a.id?i:u)}C("assistant",r.summary),W()}catch(t){const s=t instanceof Error?t.message:String(t);C("assistant",`Error: ${s}`)}finally{de("",!1),Ve(!1)}}function W(){se().then(()=>{mt(Q,o.files)})}async function Jt(){const e=o.apps.find(a=>a.id===o.currentAppId);if(e===void 0)return;await se();const n={app:e,files:o.files,exportedAt:F()},t=new Blob([JSON.stringify(n,null,2)],{type:"application/json"}),s=URL.createObjectURL(t),r=document.createElement("a");r.href=s,r.download=`${e.name.replace(/\s+/g,"-")}.json`,r.click(),URL.revokeObjectURL(s)}function qt(){Z.value="",Z.click()}async function Wt(){var n;const e=(n=Z.files)==null?void 0:n[0];if(e!==void 0)try{const t=await e.text(),s=JSON.parse(t);if(s.app===void 0||typeof s.app.name!="string"||!Array.isArray(s.files))throw new Error("Invalid app JSON format.");const r=K(),a={id:r,name:`${s.app.name} (imported)`,createdAt:s.app.createdAt??F(),updatedAt:F()},i=s.files.filter(u=>typeof u.name=="string"&&typeof u.content=="string").map(u=>({id:K(),appId:r,name:u.name,content:u.content}));await re(a),await Pn(r,i),o.apps=[...o.apps,a],await ae(r)}catch(t){const s=t instanceof Error?t.message:String(t);alert(`Import failed: ${s}`)}}function Gt(){ge.value=an(),Ze.value=on(),en.value=cn(),nn.value=String(dn()),tn.value=String(ln()),X.classList.remove("hidden"),ge.focus()}function oe(){X.classList.add("hidden")}function zt(){const e=_();e.apiKey=ge.value.trim(),e.model=Ze.value==="gpt-5.4"?"gpt-5.4":"gpt-5.3-codex",e.theme=en.value==="light"?"light":Bt;const n=Number.parseInt(nn.value,10);e.fontSize=Number.isFinite(n)&&n>=12&&n<=20?n:ye;const t=Number.parseInt(tn.value,10);e.maxToolSteps=Number.isFinite(t)&&t>=1?t:q,$t(e),pn(),oe()}function Ht(){he.value=tt(),ee.classList.remove("hidden"),he.scrollTop=0}function Le(){ee.classList.add("hidden")}function Kt(){const e=!Ue.classList.contains("collapsed");ve.textContent=e?"▸":"▾",ve.setAttribute("aria-expanded",e?"false":"true"),Ue.classList.toggle("collapsed",e)}function Yt(){const e=!$e.classList.contains("collapsed");be.textContent=e?"Files ▸":"Files ▾",be.setAttribute("aria-expanded",e?"false":"true"),$e.classList.toggle("collapsed",e),wt.classList.toggle("files-collapsed",e)}async function Qt(){const e=he.value;try{await navigator.clipboard.writeText(e),C("assistant","Agent instructions copied to clipboard.")}catch{C("assistant","Could not copy to clipboard automatically. You can still select and copy from the instructions modal.")}}o.on("set:apps",()=>bn());o.on("set:currentAppId",()=>{bn(),gn()});o.on("set:files",()=>{Se(),Ae()});o.on("set:activeFileName",()=>{Se(),Ae()});xt.addEventListener("click",hn);St.addEventListener("click",hn);At.addEventListener("click",Ut);kt.addEventListener("click",()=>{Vt()});Lt.addEventListener("click",()=>{Jt()});me.addEventListener("click",()=>{yn()});jt.addEventListener("click",W);Et.addEventListener("click",W);Tt.addEventListener("click",Gt);It.addEventListener("click",Ht);ve.addEventListener("click",Kt);be.addEventListener("click",Yt);Ot.addEventListener("click",oe);Nt.addEventListener("click",zt);Pt.addEventListener("click",oe);X.addEventListener("click",e=>{e.target===X&&oe()});Ft.addEventListener("click",Le);Mt.addEventListener("click",Le);Dt.addEventListener("click",()=>{Qt()});ee.addEventListener("click",e=>{e.target===ee&&Le()});z.addEventListener("click",()=>{});Ct.addEventListener("click",ke);Rt.addEventListener("click",ke);M.addEventListener("click",e=>{e.target===M&&ke()});P.addEventListener("keydown",e=>{e.key==="Enter"&&z.click()});fe.addEventListener("keydown",e=>{e.key==="Enter"&&!e.shiftKey&&(e.preventDefault(),yn())});I.addEventListener("change",()=>{const e=I.value;e===""||e===o.activeFileName||(se(),o.activeFileName=e)});Y.addEventListener("blur",()=>{se()});Z.addEventListener("change",()=>{Wt()});const ie=document.createElement("button");ie.className="btn btn-ghost btn-full";ie.textContent="↑ Import";ie.addEventListener("click",qt);const Je=document.querySelector(".sidebar-footer");Je!==null&&Je.appendChild(ie);window.listFileset=un;window.readFile=Ee;window.setFileContent=xe;window.replaceFilePart=mn;window.deleteFile=fn;window.evalInApp=vn;async function Xt(){pn();const e=await Tn();if(o.apps=e,e.length>0){const n=[...e].sort((t,s)=>s.updatedAt.localeCompare(t.updatedAt));await ae(n[0].id)}else gn()}Xt().catch(e=>{console.error("App Builder init failed:",e)});
