(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function t(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(s){if(s.ep)return;s.ep=!0;const a=t(s);fetch(s.href,a)}})();class on extends Error{constructor(n,t,r,s,a){super(n),this.name="ListenerError",this.error=t,this.object=r,this.event=s,this.listener=a}}function D(e){if(typeof e!="string"&&typeof e!="symbol")throw new TypeError("Expect event to be a string or symbol.")}function X(e){return typeof e=="function"}function Ee(e){if(X(e))return e}function De(e){return typeof e=="object"&&e!==null}function oe(e){if(!X(e))throw new TypeError("Expect a function.")}const ln=(e=Object.create(null),n={})=>{if(!De(e)&&!X(e))throw new TypeError("Expect an object or a function.");for(const l of["on","once","off","emit","emitAsync","has"])if(l in e)throw new Error(`Method "${l}" already exists.`);const{strict:t=!1,trace:r=null,error:s=null}=n,a=Ee(r)??null,i=Ee(s)??null,u=e!==R,g=(l,d)=>{a==null||a(l,d),u&&R.emit(l,d)};g("new",{object:e});const j=new Set,v=new Map,y={enumerable:!1,configurable:!0,writable:!0};return Object.defineProperties(e,{on:Object.assign({value:E},y),once:Object.assign({value:x},y),off:Object.assign({value:h},y),emit:Object.assign({value:k},y),emitAsync:Object.assign({value:L},y),has:Object.assign({value:A},y)}),e;function c(l,d){let f=v.get(l);f||v.set(l,f=new Set),f.add(d)}function b(l,d){const f=v.get(l);if(!f)return!1;const w=f.delete(d);return f.size===0&&v.delete(l),w}function m(l,d,f){const w={error:f,object:e,event:l,listener:d};if(i==null||i(w),e===R&&l==="error")throw new on("Error in a global error listener.",f,e,l,d);R.emit("error",w)}function E(l,d){D(l),oe(d),g("on",{object:e,event:l,listener:d}),c(l,d);let f=!0;return()=>f?(f=!1,b(l,d)):!1}function x(l,d){D(l),oe(d);const f=E(l,(...w)=>{f(),d(...w)});return f}function h(l,d){return D(l),oe(d),g("off",{object:e,event:l,listener:d}),b(l,d)}function A(l){var d;return D(l),(((d=v.get(l))==null?void 0:d.size)??0)>0}function k(l,...d){D(l);const f=v.get(l)||j;if(g("emit",{object:e,listeners:[...f],event:l,args:d}),f.size!==0)for(const w of f)try{w(...d)}catch(I){if(m(l,w,I),t)throw I}}async function L(l,...d){D(l);const f=v.get(l)||j;if(g("emitAsync",{object:e,listeners:[...f],event:l,args:d}),f.size===0)return;const w=[...f].map(async I=>{try{await I(...d)}catch(xe){if(m(l,I,xe),t)throw xe}});await(t?Promise.all(w):Promise.allSettled(w))}},R=ln;R(R);function cn(e){return!De(e)&&!X(e)?!1:typeof e.on=="function"}function Be(e){if(cn(e))return e}function T(e){return typeof e=="function"}function me(e){return typeof e=="object"&&e!==null}function $e(e){if(!T(e))throw new TypeError("Expect a function.")}function le(e){if(e.trim()==="")throw new TypeError("Expect watch path to be a non-empty string.");const n=e.split(".");for(const t of n)if(t.trim()==="")throw new TypeError("Expect watch path segments to be non-empty.");return e.split(".").map(t=>t.trim()).filter(t=>t!=="")}function dn(e,n){const t=le(n);if(t.length===0)return;let r=e;for(const s of t){if(!me(r)||!(s in r))return;r=r[s]}return r}const _e=(e,n,t)=>{if(Array.isArray(e))throw new TypeError("Watching arrays is not supported.");$e(t);const r=typeof n=="string"?[n]:n;if(!Array.isArray(r))throw new TypeError("Expect properties to be a string or an array of strings.");for(const i of r){if(typeof i!="string")throw new TypeError("Expect properties to be a string or an array of strings.");le(i)}const s=()=>r.map(i=>dn(e,i)),a=[];for(const i of r){const u=le(i);let g=null;const j=()=>{const v=[],y=(c,b)=>{if(!me(c)||b>=u.length)return;const m=u[b],E=Be(c);if(E){const x=E.on(`set:${m}`,()=>{t(...s()),b<u.length-1&&g&&(g(),g=j())});v.push(x)}b<u.length-1&&y(c[m],b+1)};return y(e,0),()=>v.reduce((c,b)=>b()||c,!1)};g=j(),a.push(()=>g?g():!1)}return t(...s()),()=>a.reduce((i,u)=>u()||i,!1)};function pn(e,n){"watch"in e||Object.defineProperty(e,"watch",{configurable:!0,writable:!0,enumerable:!1,value(t,r){return n(typeof t=="string"?this:this,t,r)}})}function Se(e,n){return Object.prototype.hasOwnProperty.call(e,n)}function ie(e){if(typeof e=="symbol")return!1;const n=typeof e=="number"?e:Number(e);return!Number.isInteger(n)||n<0||n>=4294967295?!1:typeof e=="number"||e===String(n)}function un(e){return Be(e)?T(e.emit):!1}const Ue=(e,n={})=>{const{eventful:t=R,trace:r=null,shallow:s=!1}=n;$e(t);const a=Z.options,i=new WeakMap,u=c=>{if(s||!me(c)||un(c))return c;if(i.has(c))return i.get(c);const b=Ue(c,{eventful:t,trace:r,shallow:s});return i.set(c,b),b},g=c=>{if(!s){if(Array.isArray(c)){for(let b=0;b<c.length;b++)c[b]=u(c[b]);return}for(const b of Reflect.ownKeys(c))Se(c,b)&&(c[b]=u(c[b]))}},j=c=>{const b=Array.isArray(c);g(c),pn(c,_e);let m;const E=new Proxy(c,{set(x,h,A,k){const L=b&&ie(h),l=Reflect.get(x,h,k),d=Reflect.set(x,h,u(A),k);if(m&&d){const f=Reflect.get(x,h,k);if(!Object.is(l,f)){const w=L?{index:Number(h),value:f,previous:l}:{property:h,value:f,previous:l},I=r||a.trace;m.emit(`set:${String(h)}`,w),T(I)&&I(m,"set",w),m.emit("set",w)}}return d},deleteProperty(x,h){const A=b&&ie(h),k=Se(x,h),L=k?x[h]:void 0,l=Reflect.deleteProperty(x,h);if(m&&l&&k){const d=A?{index:Number(h),previous:L}:{property:h,previous:L},f=r||a.trace;m.emit(`delete:${String(h)}`,d),T(f)&&f(m,"delete",d),m.emit("delete",d)}return l},defineProperty(x,h,A){const k=Object.getOwnPropertyDescriptor(x,h)??null,L=Object.prototype.hasOwnProperty.call(A,"value")?{...A,value:u(A.value)}:A,l=Reflect.defineProperty(x,h,L),d=b&&(h==="length"||ie(h));if(m&&!d&&l){const f={property:h,descriptor:L,previous:k},w=r||a.trace;m.emit(`define:${String(h)}`,f),T(w)&&w(m,"define",f),m.emit("define",f)}return l}});return m=T(c==null?void 0:c.emit)?E:t(E),m},v=r||a.trace;if(Array.isArray(e)){const c=j(e);return T(v)&&v(c,"new"),c}if(e!==null&&typeof e=="object"){const c=j(e);return T(v)&&v(c,"new",{object:c}),c}const y=t({get value(){return e},set value(c){if(Object.is(c,e))return;const b=e;e=c;const m={property:"value",value:e,previous:b};y.emit("set:value",m),T(v)&&v(y,"set",m),y.emit("set",m)}});return T(v)&&v(y,"new",{object:y}),y},Z=Ue;Z.options={trace:null};Z.watch=_e;const o=Z({apps:[],currentAppId:null,files:[],activeFileName:null,generating:!1,error:null});function S(e){return new Promise((n,t)=>{e.addEventListener("success",()=>{n(e.result)}),e.addEventListener("error",()=>{t(e.error??new Error("IndexedDB request failed"))})})}function fn(e,n){return new Promise((t,r)=>{const s=indexedDB.open(e,n.length);s.addEventListener("upgradeneeded",a=>{const i=n.slice(a.oldVersion-1,a.newVersion??n.length-1);for(const u of i)u(s.result)}),s.addEventListener("success",()=>{t(s.result)}),s.addEventListener("blocked",()=>{r(new Error("Database opening is blocked"))}),s.addEventListener("error",()=>{r(s.error??new Error("Failed to open database"))})})}const mn="asljs-app-builder";let q=null;async function F(){return q!==null||(q=await fn(mn,[e=>{e.createObjectStore("apps",{keyPath:"id"}),e.createObjectStore("files",{keyPath:"id"}).createIndex("byAppId","appId",{unique:!1})}])),q}async function vn(){const n=(await F()).transaction("apps","readonly");return S(n.objectStore("apps").getAll())}async function ee(e){const t=(await F()).transaction("apps","readwrite");await S(t.objectStore("apps").put(e))}async function bn(e){const t=(await F()).transaction(["apps","files"],"readwrite");await S(t.objectStore("apps").delete(e));const r=t.objectStore("files"),s=await S(r.index("byAppId").getAllKeys(e));for(const a of s)await S(r.delete(a))}async function hn(e){const t=(await F()).transaction("files","readonly");return S(t.objectStore("files").index("byAppId").getAll(e))}async function ce(e){const t=(await F()).transaction("files","readwrite");await S(t.objectStore("files").put(e))}async function gn(e){const t=(await F()).transaction("files","readwrite");await S(t.objectStore("files").delete(e))}async function yn(e,n){const s=(await F()).transaction("files","readwrite").objectStore("files"),a=await S(s.index("byAppId").getAllKeys(e));for(const i of a)await S(s.delete(i));for(const i of n)await S(s.put(i))}const wn=`# observable\r
\r
...
... [truncated]`}function J(e,n){try{return JSON.parse(e).version??"latest"}catch{return console.warn(`Failed to parse package metadata for ${n}.`),"latest"}}function Kn(e){const n=e.error;return typeof(n==null?void 0:n.message)=="string"?n.message:null}async function zn(e,n){const t=Xn(e),r=Yn(e.arguments);try{switch(t){case"listFileset":{const s=await n.listFileset();return B(s)}case"readFile":{const s=await n.readFile(O(r,"path"));return B(s)}case"setFileContent":return await n.setFileContent(O(r,"path"),O(r,"content")),B("ok");case"replaceFilePart":return await n.replaceFilePart(O(r,"path"),O(r,"search"),O(r,"replacement"),nt(r,"replaceAll",!1)),B("ok");case"deleteFile":return await n.deleteFile(O(r,"path")),B("ok");case"evalInApp":{const s=await n.evalInApp(O(r,"code"));return B(s)}default:return ke(`Unknown tool: ${t}`)}}catch(s){return ke(s instanceof Error?s.message:String(s))}}function Yn(e){if(e===void 0)return{};if(typeof e=="object"&&e!==null)return e;if(typeof e!="string")throw new Error("Invalid tool arguments value.");try{const n=JSON.parse(e);if(typeof n!="object"||n===null)throw new Error("Tool arguments must be a JSON object.");return n}catch{throw new Error("Invalid tool arguments JSON.")}}function Qn(e){return e.type==="function_call"}function Xn(e){if(typeof e.name!="string"||e.name.trim()==="")throw new Error("Tool call missing function name.");return e.name}function Zn(e){if(typeof e.call_id!="string"||e.call_id.trim()==="")throw new Error("Tool call missing call_id.");return e.call_id}function et(e){return typeof e.output_text=="string"&&e.output_text.trim()!==""?e.output_text.trim():Array.isArray(e.output)?e.output.filter(t=>t.type==="message").flatMap(t=>t.content??[]).map(t=>t.text??"").map(t=>t.trim()).filter(t=>t!=="").join(`
`):""}function O(e,n){const t=e[n];if(typeof t!="string")throw new Error(`Tool argument "${n}" must be a string.`);return t}function nt(e,n,t){const r=e[n];if(r===void 0)return t;if(typeof r!="boolean")throw new Error(`Tool argument "${n}" must be a boolean.`);return r}function B(e){return Je({ok:!0,value:e})}function ke(e){return Je({ok:!1,error:e})}function Je(e){try{return JSON.stringify(e)}catch{return'{"ok":false,"error":"Failed to serialize tool result."}'}}const ve="asljs-app-builder:eval-request",We="asljs-app-builder:eval-response",Te=`<script>
(() => {
  const REQUEST = '${ve}';
  const RESPONSE = '${We}';
...
<\/script>`;function tt(e,n){if(n.length===0){e.removeAttribute("srcdoc"),e.src="about:blank";return}const t=n.find(a=>a.name==="index.html")??n.find(a=>a.name.endsWith(".html"))??null;if(t===null){e.removeAttribute("srcdoc"),e.src="about:blank";return}let r=t.content;const s=n.find(a=>a.name==="style.css")??n.find(a=>a.name.endsWith(".css"))??null;s!==null&&(r=r.replace(/<link[^>]+href=["']style\.css["'][^>]*>/gi,`<style>${s.content}</style>`),r=r.replace(/<link[^>]+href=["']([^"']+\.css)["'][^>]*>/gi,`<style>${s.content}</style>`));for(const a of n){if(!a.name.endsWith(".js"))continue;const i=a.name.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");r=r.replace(new RegExp(`(<script[^>]*?)\\s+src=["']${i}["']([^>]*)><\\/script>`,"gi"),(u,g,j)=>{const v=`${String(g)} ${String(j)}`;return/type=["']module["']/i.test(v)?`<script type="module">${a.content}<\/script>`:`<script>${a.content}<\/script>`})}r=st(r,n),r=rt(r),e.srcdoc=r}async function Le(e,n){const t=e.contentWindow;if(t===null)throw new Error("Preview frame is not available.");const r=crypto.randomUUID();return new Promise((s,a)=>{const i=window.setTimeout(()=>{g(),a(new Error("Timed out waiting for app evaluation result."))},5e3),u=j=>{if(j.source!==t)return;const v=j.data;if(!(v.type!==We||v.id!==r)){if(g(),v.ok===!0){s(v.value);return}a(new Error(v.error??"Unknown preview evaluation error."))}};function g(){window.clearTimeout(i),window.removeEventListener("message",u)}window.addEventListener("message",u),t.postMessage({type:ve,id:r,code:n},"*")})}function rt(e){return e.includes(ve)?e:e.includes("</body>")?e.replace("</body>",`${Te}</body>`):`${e}
${Te}`}function st(e,n){if(/type=["']importmap["']/i.test(e))return e;const t=n.find(i=>i.name==="package.json")??null,r=at(t==null?void 0:t.content),s=Object.fromEntries(r.map(([i,u])=>[i,`https://esm.sh/${i}@${u}?bundle`]));if(Object.keys(s).length===0)return e;const a=`<script type="importmap">${JSON.stringify({imports:s})}<\/script>`;return/<head[^>]*>/i.test(e)?e.replace(/<head[^>]*>/i,i=>`${i}
${a}`):`${a}
${e}`}function at(e){if(e===void 0)return Ie();try{const n=JSON.parse(e),t={...n.dependencies??{},...n.devDependencies??{}};return["asljs-eventful","asljs-observable","asljs-data-binding","asljs-components","asljs-dali"].map(a=>[a,ot(t[a])])}catch{return Ie()}}function ot(e){if(typeof e!="string"||e.trim()==="")return"latest";const n=e.trim().replace(/^[~^<>=\s]+/,"");return n===""?"latest":n}function Ie(){return[["asljs-eventful","latest"],["asljs-observable","latest"],["asljs-data-binding","latest"],["asljs-components","latest"],["asljs-dali","latest"]]}function G(){return crypto.randomUUID()}function C(){return new Date().toISOString()}function p(e){const n=document.getElementById(e);if(n===null)throw new Error(`Missing element #${e}`);return n}const Oe=p("app-list"),Ne=p("empty-state"),Pe=p("app-workspace"),it=p("app-name-display"),Re=p("file-tabs"),H=p("file-content"),_=p("chat-messages"),de=p("chat-input"),pe=p("btn-generate"),lt=p("btn-run"),ct=p("btn-refresh-preview"),K=p("preview-frame"),dt=p("btn-new-app"),pt=p("btn-new-app-2"),ut=p("btn-rename"),ft=p("btn-delete-app"),mt=p("btn-export"),vt=p("btn-settings"),bt=p("btn-agent-instructions"),z=p("settings-modal"),ht=p("btn-close-settings"),gt=p("btn-save-settings"),yt=p("btn-cancel-settings"),ue=p("api-key-input"),qe=p("model-select"),Ge=p("max-tool-steps-input"),M=p("name-modal"),He=p("name-modal-title"),N=p("app-name-input"),W=p("btn-confirm-name"),wt=p("btn-cancel-name"),jt=p("btn-close-name-modal"),Y=p("import-file"),Q=p("agent-instructions-modal"),fe=p("agent-instructions-text"),xt=p("btn-close-agent-instructions"),Et=p("btn-close-agent-instructions-2"),St=p("btn-copy-agent-instructions"),Ke="asljs-app-builder-settings";function ne(){try{const e=localStorage.getItem(Ke)??"{}";return JSON.parse(e)}catch{return{}}}function At(e){localStorage.setItem(Ke,JSON.stringify(e))}function ze(){return ne().apiKey??""}function Ye(){const e=ne().model;return e==="gpt-5.3-codex"||e==="gpt-5.4"?e:Vn}function Qe(){const e=ne().maxToolSteps;if(!Number.isFinite(e))return U;const n=Math.floor(e);return n<1?U:n}function kt(){if(o.currentAppId===null)throw new Error("No active app. Create or open an app first.");return o.currentAppId}async function Xe(){return[...o.files].map(e=>e.name).sort((e,n)=>e.localeCompare(n))}async function be(e){const n=o.files.find(t=>t.name===e);if(n===void 0)throw new Error(`File not found: ${e}`);return n.content}async function he(e,n){const t=kt(),r=o.files.find(a=>a.name===e);if(r!==void 0){const a={...r,content:n};await ce(a),o.files=o.files.map(i=>i.id===a.id?a:i),o.activeFileName=a.name;return}const s={id:G(),appId:t,name:e,content:n};await ce(s),o.files=[...o.files,s],o.activeFileName=s.name}async function Ze(e){var r;const n=o.files.find(s=>s.name===e);if(n===void 0)return;await gn(n.id);const t=o.files.filter(s=>s.id!==n.id);o.files=t,o.activeFileName===e&&(o.activeFileName=((r=t[0])==null?void 0:r.name)??null)}async function en(e,n,t,r=!1){if(n==="")throw new Error("Search text cannot be empty.");const s=await be(e);if(!s.includes(n))throw new Error(`Search text not found in ${e}.`);let a=s;if(r)a=s.split(n).join(t);else{const i=s.indexOf(n);if(s.indexOf(n,i+n.length)!==-1)throw new Error("Search text is ambiguous. Use replaceAll=true or provide a more specific search block.");a=s.slice(0,i)+t+s.slice(i+n.length)}await he(e,a)}async function nn(e){if(o.files.length===0)throw new Error("No files available to run.");V();try{return await Le(K,e)}catch{return V(),Le(K,e)}}function tn(){Oe.replaceChildren();const e=[...o.apps].sort((n,t)=>t.updatedAt.localeCompare(n.updatedAt));for(const n of e){const t=document.createElement("div");t.className="app-item"+(n.id===o.currentAppId?" active":""),t.dataset.id=n.id;const r=document.createElement("span");r.className="app-item-name",r.textContent=n.name,t.appendChild(r),t.addEventListener("click",()=>{re(n.id)}),Oe.appendChild(t)}}function rn(){const e=o.apps.find(n=>n.id===o.currentAppId);if(e===void 0){Ne.classList.remove("hidden"),Pe.classList.add("hidden");return}Ne.classList.add("hidden"),Pe.classList.remove("hidden"),it.textContent=e.name,ge(),ye()}function ge(){Re.replaceChildren();for(const e of o.files){const n=document.createElement("div");n.className="file-tab"+(e.name===o.activeFileName?" active":""),n.textContent=e.name,n.addEventListener("click",()=>{te(),o.activeFileName=e.name}),Re.appendChild(n)}}function ye(){const e=o.files.find(n=>n.name===o.activeFileName);H.value=(e==null?void 0:e.content)??"",H.disabled=e===void 0}function Ce(e){o.generating=e,pe.disabled=e,pe.innerHTML=e?'<span class="spinner"></span> Generating…':"Generate"}function P(e,n){const t=document.createElement("div");t.className=`chat-msg ${e}`;const r=document.createElement("div");r.className="chat-msg-role",r.textContent=e==="user"?"You":"Assistant";const s=document.createElement("div");s.className="chat-bubble",s.textContent=n,t.appendChild(r),t.appendChild(s),_.appendChild(t),_.scrollTop=_.scrollHeight}async function te(){if(o.activeFileName===null||o.currentAppId===null)return;const e=o.files.find(t=>t.name===o.activeFileName);if(e===void 0)return;const n=H.value;e.content!==n&&(e.content=n,await ce(e))}async function re(e){var t;o.currentAppId=e;const n=await hn(e);o.files=n,o.activeFileName=((t=n[0])==null?void 0:t.name)??null,_.replaceChildren()}function sn(){He.textContent="New App",N.value="",M.classList.remove("hidden"),N.focus(),W.onclick=async()=>{const e=N.value.trim();if(e==="")return;M.classList.add("hidden");const n={id:G(),name:e,createdAt:C(),updatedAt:C()};await ee(n),o.apps=[...o.apps,n],await re(n.id)}}function we(){M.classList.add("hidden"),W.onclick=null}function Tt(){const e=o.apps.find(n=>n.id===o.currentAppId);e!==void 0&&(He.textContent="Rename App",N.value=e.name,M.classList.remove("hidden"),N.focus(),N.select(),W.onclick=async()=>{const n=N.value.trim();if(n==="")return;M.classList.add("hidden");const t={...e,name:n,updatedAt:C()};await ee(t),o.apps=o.apps.map(r=>r.id===e.id?t:r)})}async function Lt(){const e=o.apps.find(n=>n.id===o.currentAppId);e!==void 0&&confirm(`Delete "${e.name}"? This cannot be undone.`)&&(await bn(e.id),o.apps=o.apps.filter(n=>n.id!==e.id),o.currentAppId=null,o.files=[],o.activeFileName=null,_.replaceChildren(),K.src="about:blank")}async function an(){const e=de.value.trim();if(e==="")return;const n=ze();if(n===""){P("assistant","No OpenAI API key set. Open Settings (⚙) to add your key. Generation is optional — you can also create files manually.");return}if(o.currentAppId===null){P("assistant","Please create or open an app first.");return}de.value="",P("user",e),Ce(!0);try{const t=Ye(),r=Qe(),s=await qn(e,n,t,{listFileset:Xe,readFile:be,setFileContent:he,replaceFilePart:en,deleteFile:Ze,evalInApp:nn},{initialToolStepLimit:r,onToolStepLimit:async({stepsCompleted:i})=>confirm(`AI reached ${i} tool steps without finishing. Continue for 12 more steps?`)}),a=o.apps.find(i=>i.id===o.currentAppId);if(a!==void 0){const i={...a,updatedAt:C()};await ee(i),o.apps=o.apps.map(u=>u.id===a.id?i:u)}P("assistant",s.summary),V()}catch(t){const r=t instanceof Error?t.message:String(t);P("assistant",`Error: ${r}`)}finally{Ce(!1)}}function V(){te().then(()=>{tt(K,o.files)})}async function It(){const e=o.apps.find(a=>a.id===o.currentAppId);if(e===void 0)return;await te();const n={app:e,files:o.files,exportedAt:C()},t=new Blob([JSON.stringify(n,null,2)],{type:"application/json"}),r=URL.createObjectURL(t),s=document.createElement("a");s.href=r,s.download=`${e.name.replace(/\s+/g,"-")}.json`,s.click(),URL.revokeObjectURL(r)}function Ot(){Y.value="",Y.click()}async function Nt(){var n;const e=(n=Y.files)==null?void 0:n[0];if(e!==void 0)try{const t=await e.text(),r=JSON.parse(t);if(r.app===void 0||typeof r.app.name!="string"||!Array.isArray(r.files))throw new Error("Invalid app JSON format.");const s=G(),a={id:s,name:`${r.app.name} (imported)`,createdAt:r.app.createdAt??C(),updatedAt:C()},i=r.files.filter(u=>typeof u.name=="string"&&typeof u.content=="string").map(u=>({id:G(),appId:s,name:u.name,content:u.content}));await ee(a),await yn(s,i),o.apps=[...o.apps,a],await re(s)}catch(t){const r=t instanceof Error?t.message:String(t);alert(`Import failed: ${r}`)}}function Pt(){ue.value=ze(),qe.value=Ye(),Ge.value=String(Qe()),z.classList.remove("hidden"),ue.focus()}function se(){z.classList.add("hidden")}function Rt(){const e=ne();e.apiKey=ue.value.trim(),e.model=qe.value==="gpt-5.4"?"gpt-5.4":"gpt-5.3-codex";const n=Number.parseInt(Ge.value,10);e.maxToolSteps=Number.isFinite(n)&&n>=1?n:U,At(e),se()}function Ct(){fe.value=Jn(),Q.classList.remove("hidden"),fe.scrollTop=0}function je(){Q.classList.add("hidden")}async function Mt(){const e=fe.value;try{await navigator.clipboard.writeText(e),P("assistant","Agent instructions copied to clipboard.")}catch{P("assistant","Could not copy to clipboard automatically. You can still select and copy from the instructions modal.")}}o.on("set:apps",()=>tn());o.on("set:currentAppId",()=>{tn(),rn()});o.on("set:files",()=>{ge(),ye()});o.on("set:activeFileName",()=>{ge(),ye()});dt.addEventListener("click",sn);pt.addEventListener("click",sn);ut.addEventListener("click",Tt);ft.addEventListener("click",()=>{Lt()});mt.addEventListener("click",()=>{It()});pe.addEventListener("click",()=>{an()});lt.addEventListener("click",V);ct.addEventListener("click",V);vt.addEventListener("click",Pt);bt.addEventListener("click",Ct);ht.addEventListener("click",se);gt.addEventListener("click",Rt);yt.addEventListener("click",se);z.addEventListener("click",e=>{e.target===z&&se()});xt.addEventListener("click",je);Et.addEventListener("click",je);St.addEventListener("click",()=>{Mt()});Q.addEventListener("click",e=>{e.target===Q&&je()});W.addEventListener("click",()=>{});wt.addEventListener("click",we);jt.addEventListener("click",we);M.addEventListener("click",e=>{e.target===M&&we()});N.addEventListener("keydown",e=>{e.key==="Enter"&&W.click()});de.addEventListener("keydown",e=>{e.key==="Enter"&&!e.shiftKey&&(e.preventDefault(),an())});H.addEventListener("blur",()=>{te()});Y.addEventListener("change",()=>{Nt()});const ae=document.createElement("button");ae.className="btn btn-ghost btn-full";ae.textContent="↑ Import";ae.addEventListener("click",Ot);const Me=document.querySelector(".sidebar-footer"),Fe=document.getElementById("btn-settings");Me!==null&&Fe!==null&&Me.insertBefore(ae,Fe);window.listFileset=Xe;window.readFile=be;window.setFileContent=he;window.replaceFilePart=en;window.deleteFile=Ze;window.evalInApp=nn;async function Ft(){const e=await vn();if(o.apps=e,e.length>0){const n=[...e].sort((t,r)=>r.updatedAt.localeCompare(t.updatedAt));await re(n[0].id)}else rn()}Ft().catch(e=>{console.error("App Builder init failed:",e)});
