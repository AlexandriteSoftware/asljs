(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function t(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(r){if(r.ep)return;r.ep=!0;const a=t(r);fetch(r.href,a)}})();class jn extends Error{constructor(n,t,s,r,a){super(n),this.name="ListenerError",this.error=t,this.object=s,this.event=r,this.listener=a}}function B(e){if(typeof e!="string"&&typeof e!="symbol")throw new TypeError("Expect event to be a string or symbol.")}function te(e){return typeof e=="function"}function Ie(e){if(te(e))return e}function qe(e){return typeof e=="object"&&e!==null}function ce(e){if(!te(e))throw new TypeError("Expect a function.")}const En=(e=Object.create(null),n={})=>{if(!qe(e)&&!te(e))throw new TypeError("Expect an object or a function.");for(const l of["on","once","off","emit","emitAsync","has"])if(l in e)throw new Error(`Method "${l}" already exists.`);const{strict:t=!1,trace:s=null,error:r=null}=n,a=Ie(s)??null,i=Ie(r)??null,u=e!==R,g=(l,p)=>{a==null||a(l,p),u&&R.emit(l,p)};g("new",{object:e});const j=new Set,v=new Map,y={enumerable:!1,configurable:!0,writable:!0};return Object.defineProperties(e,{on:Object.assign({value:x},y),once:Object.assign({value:E},y),off:Object.assign({value:h},y),emit:Object.assign({value:L},y),emitAsync:Object.assign({value:T},y),has:Object.assign({value:A},y)}),e;function c(l,p){let f=v.get(l);f||v.set(l,f=new Set),f.add(p)}function b(l,p){const f=v.get(l);if(!f)return!1;const w=f.delete(p);return f.size===0&&v.delete(l),w}function m(l,p,f){const w={error:f,object:e,event:l,listener:p};if(i==null||i(w),e===R&&l==="error")throw new jn("Error in a global error listener.",f,e,l,p);R.emit("error",w)}function x(l,p){B(l),ce(p),g("on",{object:e,event:l,listener:p}),c(l,p);let f=!0;return()=>f?(f=!1,b(l,p)):!1}function E(l,p){B(l),ce(p);const f=x(l,(...w)=>{f(),p(...w)});return f}function h(l,p){return B(l),ce(p),g("off",{object:e,event:l,listener:p}),b(l,p)}function A(l){var p;return B(l),(((p=v.get(l))==null?void 0:p.size)??0)>0}function L(l,...p){B(l);const f=v.get(l)||j;if(g("emit",{object:e,listeners:[...f],event:l,args:p}),f.size!==0)for(const w of f)try{w(...p)}catch(O){if(m(l,w,O),t)throw O}}async function T(l,...p){B(l);const f=v.get(l)||j;if(g("emitAsync",{object:e,listeners:[...f],event:l,args:p}),f.size===0)return;const w=[...f].map(async O=>{try{await O(...p)}catch(Te){if(m(l,O,Te),t)throw Te}});await(t?Promise.all(w):Promise.allSettled(w))}},R=En;R(R);function xn(e){return!qe(e)&&!te(e)?!1:typeof e.on=="function"}function We(e){if(xn(e))return e}function k(e){return typeof e=="function"}function we(e){return typeof e=="object"&&e!==null}function Ge(e){if(!k(e))throw new TypeError("Expect a function.")}function ue(e){if(e.trim()==="")throw new TypeError("Expect watch path to be a non-empty string.");const n=e.split(".");for(const t of n)if(t.trim()==="")throw new TypeError("Expect watch path segments to be non-empty.");return e.split(".").map(t=>t.trim()).filter(t=>t!=="")}function Sn(e,n){const t=ue(n);if(t.length===0)return;let s=e;for(const r of t){if(!we(s)||!(r in s))return;s=s[r]}return s}const ze=(e,n,t)=>{if(Array.isArray(e))throw new TypeError("Watching arrays is not supported.");Ge(t);const s=typeof n=="string"?[n]:n;if(!Array.isArray(s))throw new TypeError("Expect properties to be a string or an array of strings.");for(const i of s){if(typeof i!="string")throw new TypeError("Expect properties to be a string or an array of strings.");ue(i)}const r=()=>s.map(i=>Sn(e,i)),a=[];for(const i of s){const u=ue(i);let g=null;const j=()=>{const v=[],y=(c,b)=>{if(!we(c)||b>=u.length)return;const m=u[b],x=We(c);if(x){const E=x.on(`set:${m}`,()=>{t(...r()),b<u.length-1&&g&&(g(),g=j())});v.push(E)}b<u.length-1&&y(c[m],b+1)};return y(e,0),()=>v.reduce((c,b)=>b()||c,!1)};g=j(),a.push(()=>g?g():!1)}return t(...r()),()=>a.reduce((i,u)=>u()||i,!1)};function An(e,n){"watch"in e||Object.defineProperty(e,"watch",{configurable:!0,writable:!0,enumerable:!1,value(t,s){return n(typeof t=="string"?this:this,t,s)}})}function Oe(e,n){return Object.prototype.hasOwnProperty.call(e,n)}function de(e){if(typeof e=="symbol")return!1;const n=typeof e=="number"?e:Number(e);return!Number.isInteger(n)||n<0||n>=4294967295?!1:typeof e=="number"||e===String(n)}function Ln(e){return We(e)?k(e.emit):!1}const He=(e,n={})=>{const{eventful:t=R,trace:s=null,shallow:r=!1}=n;Ge(t);const a=re.options,i=new WeakMap,u=c=>{if(r||!we(c)||Ln(c))return c;if(i.has(c))return i.get(c);const b=He(c,{eventful:t,trace:s,shallow:r});return i.set(c,b),b},g=c=>{if(!r){if(Array.isArray(c)){for(let b=0;b<c.length;b++)c[b]=u(c[b]);return}for(const b of Reflect.ownKeys(c))Oe(c,b)&&(c[b]=u(c[b]))}},j=c=>{const b=Array.isArray(c);g(c),An(c,ze);let m;const x=new Proxy(c,{set(E,h,A,L){const T=b&&de(h),l=Reflect.get(E,h,L),p=Reflect.set(E,h,u(A),L);if(m&&p){const f=Reflect.get(E,h,L);if(!Object.is(l,f)){const w=T?{index:Number(h),value:f,previous:l}:{property:h,value:f,previous:l},O=s||a.trace;m.emit(`set:${String(h)}`,w),k(O)&&O(m,"set",w),m.emit("set",w)}}return p},deleteProperty(E,h){const A=b&&de(h),L=Oe(E,h),T=L?E[h]:void 0,l=Reflect.deleteProperty(E,h);if(m&&l&&L){const p=A?{index:Number(h),previous:T}:{property:h,previous:T},f=s||a.trace;m.emit(`delete:${String(h)}`,p),k(f)&&f(m,"delete",p),m.emit("delete",p)}return l},defineProperty(E,h,A){const L=Object.getOwnPropertyDescriptor(E,h)??null,T=Object.prototype.hasOwnProperty.call(A,"value")?{...A,value:u(A.value)}:A,l=Reflect.defineProperty(E,h,T),p=b&&(h==="length"||de(h));if(m&&!p&&l){const f={property:h,descriptor:T,previous:L},w=s||a.trace;m.emit(`define:${String(h)}`,f),k(w)&&w(m,"define",f),m.emit("define",f)}return l}});return m=k(c==null?void 0:c.emit)?x:t(x),m},v=s||a.trace;if(Array.isArray(e)){const c=j(e);return k(v)&&v(c,"new"),c}if(e!==null&&typeof e=="object"){const c=j(e);return k(v)&&v(c,"new",{object:c}),c}const y=t({get value(){return e},set value(c){if(Object.is(c,e))return;const b=e;e=c;const m={property:"value",value:e,previous:b};y.emit("set:value",m),k(v)&&v(y,"set",m),y.emit("set",m)}});return k(v)&&v(y,"new",{object:y}),y},re=He;re.options={trace:null};re.watch=ze;const o=re({apps:[],currentAppId:null,files:[],activeFileName:null,generating:!1,error:null});function S(e){return new Promise((n,t)=>{e.addEventListener("success",()=>{n(e.result)}),e.addEventListener("error",()=>{t(e.error??new Error("IndexedDB request failed"))})})}function kn(e,n){return new Promise((t,s)=>{const r=indexedDB.open(e,n.length);r.addEventListener("upgradeneeded",a=>{const i=n.slice(a.oldVersion-1,a.newVersion??n.length-1);for(const u of i)u(r.result)}),r.addEventListener("success",()=>{t(r.result)}),r.addEventListener("blocked",()=>{s(new Error("Database opening is blocked"))}),r.addEventListener("error",()=>{s(r.error??new Error("Failed to open database"))})})}const Tn="asljs-app-builder";let H=null;async function D(){return H!==null||(H=await kn(Tn,[e=>{e.createObjectStore("apps",{keyPath:"id"}),e.createObjectStore("files",{keyPath:"id"}).createIndex("byAppId","appId",{unique:!1})}])),H}async function In(){const n=(await D()).transaction("apps","readonly");return S(n.objectStore("apps").getAll())}async function se(e){const t=(await D()).transaction("apps","readwrite");await S(t.objectStore("apps").put(e))}async function On(e){const t=(await D()).transaction(["apps","files"],"readwrite");await S(t.objectStore("apps").delete(e));const s=t.objectStore("files"),r=await S(s.index("byAppId").getAllKeys(e));for(const a of r)await S(s.delete(a))}async function Nn(e){const t=(await D()).transaction("files","readonly");return S(t.objectStore("files").index("byAppId").getAll(e))}async function fe(e){const t=(await D()).transaction("files","readwrite");await S(t.objectStore("files").put(e))}async function Pn(e){const t=(await D()).transaction("files","readwrite");await S(t.objectStore("files").delete(e))}async function Cn(e,n){const r=(await D()).transaction("files","readwrite").objectStore("files"),a=await S(r.index("byAppId").getAllKeys(e));for(const i of a)await S(r.delete(i));for(const i of n)await S(r.put(i))}const Rn=`# observable\r
\r
...
`,Kn=[{type:"function",name:"listFileset",description:"List all file paths in the virtual filesystem.",parameters:{type:"object",properties:{},required:[],additionalProperties:!1},strict:!0},{type:"function",name:"readFile",description:"Read the full text content of a file.",parameters:{type:"object",properties:{path:{type:"string"}},required:["path"],additionalProperties:!1},strict:!0},{type:"function",name:"setFileContent",description:"Create or fully replace file content.",parameters:{type:"object",properties:{path:{type:"string"},content:{type:"string"}},required:["path","content"],additionalProperties:!1},strict:!0},{type:"function",name:"replaceFilePart",description:"Replace part of a file by exact search string.",parameters:{type:"object",properties:{path:{type:"string"},search:{type:"string"},replacement:{type:"string"},replaceAll:{type:"boolean"}},required:["path","search","replacement","replaceAll"],additionalProperties:!1},strict:!0},{type:"function",name:"deleteFile",description:"Delete a file from the virtual filesystem.",parameters:{type:"object",properties:{path:{type:"string"}},required:["path"],additionalProperties:!1},strict:!0},{type:"function",name:"evalInApp",description:"Evaluate JavaScript in the running app document context.",parameters:{type:"object",properties:{code:{type:"string"}},required:["code"],additionalProperties:!1},strict:!0}],Yn="https://api.openai.com/v1/responses",Qn=G(qn,"asljs-observable"),Xn=G(Wn,"asljs-eventful"),Zn=G(Gn,"asljs-data-binding"),et=G(zn,"asljs-components"),nt=G(Hn,"asljs-dali"),Ke=it(),tt="gpt-5.3-codex",q=20;function rt(){return Ke}const st=12;async function at(e,n,t,s,r){var j;let a,i=e,u=ot(r==null?void 0:r.initialToolStepLimit),g=0;for(;;){if(await U(r,`Step ${g+1}: requesting assistant response...`),g>=u){if(!(await((j=r==null?void 0:r.onToolStepLimit)==null?void 0:j.call(r,{stepsCompleted:g,stepLimit:u}))??!1))throw new Error("AI exceeded maximum tool steps without completing.");u+=st,await U(r,`Extended step limit to ${u}. Continuing...`)}const v=await fetch(Yn,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${n}`},body:JSON.stringify({model:t,instructions:Ke,temperature:.1,previous_response_id:a,input:i,tools:Kn})});if(!v.ok){const m=await v.json().catch(()=>({})),x=lt(m)??`OpenAI API error: ${v.status}`;throw new Error(x)}const y=await v.json();if(!Array.isArray(y.output))throw new Error("AI returned an unexpected response format.");const c=y.output.filter(pt);if(c.length===0){await U(r,`Completed in ${g+1} step(s). Finalizing summary...`);const m=ft(y);return{summary:m===""?"Completed tool-based update.":m}}const b=[];for(const m of c){await U(r,`Step ${g+1}: running ${Ye(m)}...`);const x=await ct(m,s);b.push({type:"function_call_output",call_id:ut(m),output:x})}await U(r,`Step ${g+1}: submitted ${b.length} tool result(s).`),a=typeof y.id=="string"?y.id:a,i=b,g+=1}}function ot(e){if(!Number.isFinite(e))return q;const n=Math.floor(e);return n>=1?n:q}async function U(e,n){(e==null?void 0:e.onProgress)!==void 0&&await Promise.resolve(e.onProgress(n))}function it(){const e=`
...
... [truncated]`}function G(e,n){try{return JSON.parse(e).version??"latest"}catch{return console.warn(`Failed to parse package metadata for ${n}.`),"latest"}}function lt(e){const n=e.error;return typeof(n==null?void 0:n.message)=="string"?n.message:null}async function ct(e,n){const t=Ye(e),s=dt(e.arguments);try{switch(t){case"listFileset":{const r=await n.listFileset();return $(r)}case"readFile":{const r=await n.readFile(N(s,"path"));return $(r)}case"setFileContent":return await n.setFileContent(N(s,"path"),N(s,"content")),$("ok");case"replaceFilePart":return await n.replaceFilePart(N(s,"path"),N(s,"search"),N(s,"replacement"),mt(s,"replaceAll",!1)),$("ok");case"deleteFile":return await n.deleteFile(N(s,"path")),$("ok");case"evalInApp":{const r=await n.evalInApp(N(s,"code"));return $(r)}default:return Pe(`Unknown tool: ${t}`)}}catch(r){return Pe(r instanceof Error?r.message:String(r))}}function dt(e){if(e===void 0)return{};if(typeof e=="object"&&e!==null)return e;if(typeof e!="string")throw new Error("Invalid tool arguments value.");try{const n=JSON.parse(e);if(typeof n!="object"||n===null)throw new Error("Tool arguments must be a JSON object.");return n}catch{throw new Error("Invalid tool arguments JSON.")}}function pt(e){return e.type==="function_call"}function Ye(e){if(typeof e.name!="string"||e.name.trim()==="")throw new Error("Tool call missing function name.");return e.name}function ut(e){if(typeof e.call_id!="string"||e.call_id.trim()==="")throw new Error("Tool call missing call_id.");return e.call_id}function ft(e){return typeof e.output_text=="string"&&e.output_text.trim()!==""?e.output_text.trim():Array.isArray(e.output)?e.output.filter(t=>t.type==="message").flatMap(t=>t.content??[]).map(t=>t.text??"").map(t=>t.trim()).filter(t=>t!=="").join(`
