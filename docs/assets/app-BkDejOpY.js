(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function t(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(r){if(r.ep)return;r.ep=!0;const a=t(r);fetch(r.href,a)}})();class bn extends Error{constructor(n,t,s,r,a){super(n),this.name="ListenerError",this.error=t,this.object=s,this.event=r,this.listener=a}}function B(e){if(typeof e!="string"&&typeof e!="symbol")throw new TypeError("Expect event to be a string or symbol.")}function ee(e){return typeof e=="function"}function ke(e){if(ee(e))return e}function Ve(e){return typeof e=="object"&&e!==null}function le(e){if(!ee(e))throw new TypeError("Expect a function.")}const gn=(e=Object.create(null),n={})=>{if(!Ve(e)&&!ee(e))throw new TypeError("Expect an object or a function.");for(const l of["on","once","off","emit","emitAsync","has"])if(l in e)throw new Error(`Method "${l}" already exists.`);const{strict:t=!1,trace:s=null,error:r=null}=n,a=ke(s)??null,i=ke(r)??null,u=e!==R,g=(l,p)=>{a==null||a(l,p),u&&R.emit(l,p)};g("new",{object:e});const j=new Set,v=new Map,y={enumerable:!1,configurable:!0,writable:!0};return Object.defineProperties(e,{on:Object.assign({value:E},y),once:Object.assign({value:x},y),off:Object.assign({value:h},y),emit:Object.assign({value:k},y),emitAsync:Object.assign({value:T},y),has:Object.assign({value:A},y)}),e;function c(l,p){let f=v.get(l);f||v.set(l,f=new Set),f.add(p)}function b(l,p){const f=v.get(l);if(!f)return!1;const w=f.delete(p);return f.size===0&&v.delete(l),w}function m(l,p,f){const w={error:f,object:e,event:l,listener:p};if(i==null||i(w),e===R&&l==="error")throw new bn("Error in a global error listener.",f,e,l,p);R.emit("error",w)}function E(l,p){B(l),le(p),g("on",{object:e,event:l,listener:p}),c(l,p);let f=!0;return()=>f?(f=!1,b(l,p)):!1}function x(l,p){B(l),le(p);const f=E(l,(...w)=>{f(),p(...w)});return f}function h(l,p){return B(l),le(p),g("off",{object:e,event:l,listener:p}),b(l,p)}function A(l){var p;return B(l),(((p=v.get(l))==null?void 0:p.size)??0)>0}function k(l,...p){B(l);const f=v.get(l)||j;if(g("emit",{object:e,listeners:[...f],event:l,args:p}),f.size!==0)for(const w of f)try{w(...p)}catch(O){if(m(l,w,O),t)throw O}}async function T(l,...p){B(l);const f=v.get(l)||j;if(g("emitAsync",{object:e,listeners:[...f],event:l,args:p}),f.size===0)return;const w=[...f].map(async O=>{try{await O(...p)}catch(Ae){if(m(l,O,Ae),t)throw Ae}});await(t?Promise.all(w):Promise.allSettled(w))}},R=gn;R(R);function hn(e){return!Ve(e)&&!ee(e)?!1:typeof e.on=="function"}function Je(e){if(hn(e))return e}function L(e){return typeof e=="function"}function ge(e){return typeof e=="object"&&e!==null}function qe(e){if(!L(e))throw new TypeError("Expect a function.")}function pe(e){if(e.trim()==="")throw new TypeError("Expect watch path to be a non-empty string.");const n=e.split(".");for(const t of n)if(t.trim()==="")throw new TypeError("Expect watch path segments to be non-empty.");return e.split(".").map(t=>t.trim()).filter(t=>t!=="")}function yn(e,n){const t=pe(n);if(t.length===0)return;let s=e;for(const r of t){if(!ge(s)||!(r in s))return;s=s[r]}return s}const We=(e,n,t)=>{if(Array.isArray(e))throw new TypeError("Watching arrays is not supported.");qe(t);const s=typeof n=="string"?[n]:n;if(!Array.isArray(s))throw new TypeError("Expect properties to be a string or an array of strings.");for(const i of s){if(typeof i!="string")throw new TypeError("Expect properties to be a string or an array of strings.");pe(i)}const r=()=>s.map(i=>yn(e,i)),a=[];for(const i of s){const u=pe(i);let g=null;const j=()=>{const v=[],y=(c,b)=>{if(!ge(c)||b>=u.length)return;const m=u[b],E=Je(c);if(E){const x=E.on(`set:${m}`,()=>{t(...r()),b<u.length-1&&g&&(g(),g=j())});v.push(x)}b<u.length-1&&y(c[m],b+1)};return y(e,0),()=>v.reduce((c,b)=>b()||c,!1)};g=j(),a.push(()=>g?g():!1)}return t(...r()),()=>a.reduce((i,u)=>u()||i,!1)};function wn(e,n){"watch"in e||Object.defineProperty(e,"watch",{configurable:!0,writable:!0,enumerable:!1,value(t,s){return n(typeof t=="string"?this:this,t,s)}})}function Le(e,n){return Object.prototype.hasOwnProperty.call(e,n)}function ce(e){if(typeof e=="symbol")return!1;const n=typeof e=="number"?e:Number(e);return!Number.isInteger(n)||n<0||n>=4294967295?!1:typeof e=="number"||e===String(n)}function jn(e){return Je(e)?L(e.emit):!1}const Ge=(e,n={})=>{const{eventful:t=R,trace:s=null,shallow:r=!1}=n;qe(t);const a=ne.options,i=new WeakMap,u=c=>{if(r||!ge(c)||jn(c))return c;if(i.has(c))return i.get(c);const b=Ge(c,{eventful:t,trace:s,shallow:r});return i.set(c,b),b},g=c=>{if(!r){if(Array.isArray(c)){for(let b=0;b<c.length;b++)c[b]=u(c[b]);return}for(const b of Reflect.ownKeys(c))Le(c,b)&&(c[b]=u(c[b]))}},j=c=>{const b=Array.isArray(c);g(c),wn(c,We);let m;const E=new Proxy(c,{set(x,h,A,k){const T=b&&ce(h),l=Reflect.get(x,h,k),p=Reflect.set(x,h,u(A),k);if(m&&p){const f=Reflect.get(x,h,k);if(!Object.is(l,f)){const w=T?{index:Number(h),value:f,previous:l}:{property:h,value:f,previous:l},O=s||a.trace;m.emit(`set:${String(h)}`,w),L(O)&&O(m,"set",w),m.emit("set",w)}}return p},deleteProperty(x,h){const A=b&&ce(h),k=Le(x,h),T=k?x[h]:void 0,l=Reflect.deleteProperty(x,h);if(m&&l&&k){const p=A?{index:Number(h),previous:T}:{property:h,previous:T},f=s||a.trace;m.emit(`delete:${String(h)}`,p),L(f)&&f(m,"delete",p),m.emit("delete",p)}return l},defineProperty(x,h,A){const k=Object.getOwnPropertyDescriptor(x,h)??null,T=Object.prototype.hasOwnProperty.call(A,"value")?{...A,value:u(A.value)}:A,l=Reflect.defineProperty(x,h,T),p=b&&(h==="length"||ce(h));if(m&&!p&&l){const f={property:h,descriptor:T,previous:k},w=s||a.trace;m.emit(`define:${String(h)}`,f),L(w)&&w(m,"define",f),m.emit("define",f)}return l}});return m=L(c==null?void 0:c.emit)?E:t(E),m},v=s||a.trace;if(Array.isArray(e)){const c=j(e);return L(v)&&v(c,"new"),c}if(e!==null&&typeof e=="object"){const c=j(e);return L(v)&&v(c,"new",{object:c}),c}const y=t({get value(){return e},set value(c){if(Object.is(c,e))return;const b=e;e=c;const m={property:"value",value:e,previous:b};y.emit("set:value",m),L(v)&&v(y,"set",m),y.emit("set",m)}});return L(v)&&v(y,"new",{object:y}),y},ne=Ge;ne.options={trace:null};ne.watch=We;const o=ne({apps:[],currentAppId:null,files:[],activeFileName:null,generating:!1,error:null});function S(e){return new Promise((n,t)=>{e.addEventListener("success",()=>{n(e.result)}),e.addEventListener("error",()=>{t(e.error??new Error("IndexedDB request failed"))})})}function xn(e,n){return new Promise((t,s)=>{const r=indexedDB.open(e,n.length);r.addEventListener("upgradeneeded",a=>{const i=n.slice(a.oldVersion-1,a.newVersion??n.length-1);for(const u of i)u(r.result)}),r.addEventListener("success",()=>{t(r.result)}),r.addEventListener("blocked",()=>{s(new Error("Database opening is blocked"))}),r.addEventListener("error",()=>{s(r.error??new Error("Failed to open database"))})})}const En="asljs-app-builder";let H=null;async function D(){return H!==null||(H=await xn(En,[e=>{e.createObjectStore("apps",{keyPath:"id"}),e.createObjectStore("files",{keyPath:"id"}).createIndex("byAppId","appId",{unique:!1})}])),H}async function Sn(){const n=(await D()).transaction("apps","readonly");return S(n.objectStore("apps").getAll())}async function te(e){const t=(await D()).transaction("apps","readwrite");await S(t.objectStore("apps").put(e))}async function An(e){const t=(await D()).transaction(["apps","files"],"readwrite");await S(t.objectStore("apps").delete(e));const s=t.objectStore("files"),r=await S(s.index("byAppId").getAllKeys(e));for(const a of r)await S(s.delete(a))}async function kn(e){const t=(await D()).transaction("files","readonly");return S(t.objectStore("files").index("byAppId").getAll(e))}async function ue(e){const t=(await D()).transaction("files","readwrite");await S(t.objectStore("files").put(e))}async function Ln(e){const t=(await D()).transaction("files","readwrite");await S(t.objectStore("files").delete(e))}async function Tn(e,n){const r=(await D()).transaction("files","readwrite").objectStore("files"),a=await S(r.index("byAppId").getAllKeys(e));for(const i of a)await S(r.delete(i));for(const i of n)await S(r.put(i))}const In=`# observable\r
\r
...
... [truncated]`}function W(e,n){try{return JSON.parse(e).version??"latest"}catch{return console.warn(`Failed to parse package metadata for ${n}.`),"latest"}}function rt(e){const n=e.error;return typeof(n==null?void 0:n.message)=="string"?n.message:null}async function st(e,n){const t=Ke(e),s=at(e.arguments);try{switch(t){case"listFileset":{const r=await n.listFileset();return $(r)}case"readFile":{const r=await n.readFile(N(s,"path"));return $(r)}case"setFileContent":return await n.setFileContent(N(s,"path"),N(s,"content")),$("ok");case"replaceFilePart":return await n.replaceFilePart(N(s,"path"),N(s,"search"),N(s,"replacement"),ct(s,"replaceAll",!1)),$("ok");case"deleteFile":return await n.deleteFile(N(s,"path")),$("ok");case"evalInApp":{const r=await n.evalInApp(N(s,"code"));return $(r)}default:return Ie(`Unknown tool: ${t}`)}}catch(r){return Ie(r instanceof Error?r.message:String(r))}}function at(e){if(e===void 0)return{};if(typeof e=="object"&&e!==null)return e;if(typeof e!="string")throw new Error("Invalid tool arguments value.");try{const n=JSON.parse(e);if(typeof n!="object"||n===null)throw new Error("Tool arguments must be a JSON object.");return n}catch{throw new Error("Invalid tool arguments JSON.")}}function ot(e){return e.type==="function_call"}function Ke(e){if(typeof e.name!="string"||e.name.trim()==="")throw new Error("Tool call missing function name.");return e.name}function it(e){if(typeof e.call_id!="string"||e.call_id.trim()==="")throw new Error("Tool call missing call_id.");return e.call_id}function lt(e){return typeof e.output_text=="string"&&e.output_text.trim()!==""?e.output_text.trim():Array.isArray(e.output)?e.output.filter(t=>t.type==="message").flatMap(t=>t.content??[]).map(t=>t.text??"").map(t=>t.trim()).filter(t=>t!=="").join(`
`):""}function N(e,n){const t=e[n];if(typeof t!="string")throw new Error(`Tool argument "${n}" must be a string.`);return t}function ct(e,n,t){const s=e[n];if(s===void 0)return t;if(typeof s!="boolean")throw new Error(`Tool argument "${n}" must be a boolean.`);return s}function $(e){return ze({ok:!0,value:e})}function Ie(e){return ze({ok:!1,error:e})}function ze(e){try{return JSON.stringify(e)}catch{return'{"ok":false,"error":"Failed to serialize tool result."}'}}const he="asljs-app-builder:eval-request",Ye="asljs-app-builder:eval-response",Oe=`<script>
(() => {
  const REQUEST = '${he}';
  const RESPONSE = '${Ye}';
