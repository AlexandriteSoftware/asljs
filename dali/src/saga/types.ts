...
export type SagaUndoOperation =
  | { type: 'delete'; tableName: string; key: IDBValidKey; }
  | { type: 'put'; tableName: string; record: Record<string, any>; }
  | { type: 'clear'; tableName: string; records: Record<string, any>[]; };

export type SagaForwardOperation =
  | { type: 'add'; tableName: string; record: Record<string, any>; }
  | {
    type: 'update';
    tableName: string;
  ...
  | { type: 'delete'; tableName: string; record: Record<string, any>; }
  | { type: 'clear'; tableName: string; records: Record<string, any>[]; };
