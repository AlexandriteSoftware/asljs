...
export const AiChatModelDefinition =
  createComponentModelDefinition(
    ...
    [ { name: 'messages',
      ...
      { name: 'promptDraft',
        type: 'string',
        description: 'Current prompt draft text.' },
      { name: 'messagesScrollTop',
        type: 'number',
        title: 'Messages scroll top',
        description: 'Current persisted message list scroll position.' },
      { name: 'hasMessagesScrollTop',
        type: 'boolean',
        title: 'Has messages scroll top',
        description: 'Whether a persisted scroll position has been captured.' },
      { name: 'missingKeyMessageShown',
        type: 'boolean',
        title: 'Missing key message shown',
        description: 'Whether the missing-credentials warning has been shown.' },
      { name: 'lastResponseId',
        type: 'string',
      ...
      { name: 'choicePrompt',
        type: 'object',
        description: 'Current choice prompt state.',
        editable: false },
      { name: 'progress',
        type: 'object',
        description: 'Current in-progress request state.',
        editable: false },
      { name: 'sending',
        type: 'boolean',
