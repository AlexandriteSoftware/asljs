    ...
    try {
      ...
      const output =
        document.getElementById(
          'share-link-output') as HTMLTextAreaElement;

      const status =
        document.getElementById(
          'share-link-status') as HTMLElement;

      const minified =
        document.getElementById(
          'share-minified-input') as HTMLInputElement;
...
test(
  ...
  async () =>
  {
    ...
    try {
      ...
      const shareButton =
        document.getElementById(
          'btn-share-link') as HTMLElement;

      const downloadButton =
        document.getElementById(
          'btn-share-download') as HTMLElement;

      const excludeTests =
        document.getElementById(
          'share-exclude-tests-input') as HTMLInputElement;
