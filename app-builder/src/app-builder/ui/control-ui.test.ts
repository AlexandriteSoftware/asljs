...
test(
  ...
  () =>
  {
    ...
    try {
      const button =
        mustElement<AppBuilderButtonElement>('button');

      const input =
        mustElement<AppBuilderTextInputElement>('input');

      const select =
        mustElement<AppBuilderSelectElement>('select');
...
test(
  ...
  () =>
  {
    ...
    try {
      ...
      const nativeButton =
        mustElement<HTMLButtonElement>('native');
